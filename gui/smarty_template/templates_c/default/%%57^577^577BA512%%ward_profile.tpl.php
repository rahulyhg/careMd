<?php /* Smarty version 2.6.22, created on 2019-02-05 10:09:38
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="adm_input"><textarea name="description" cols=40 rows=8
                                    wrap="physical"><?php echo $this->_tpl_vars['description']; ?>
</textarea></td>
                        ...
                        <tr>
                            ...
                            <td class="adm_input"><textarea name="room_nr_start" cols=4 rows=1
                                    wrap="physical"><?php echo $this->_tpl_vars['room_nr_start']; ?>
</textarea></td>
                        ...
                        <tr>
                            ...
                            <td class="adm_input"><textarea name="room_nr_end" cols=4 rows=1
                                    wrap="physical"><?php echo $this->_tpl_vars['room_nr_end']; ?>
</textarea></td>
                        ...
                        <tr>
                            ...
                            <td class="adm_input"><textarea name="roomprefix" cols=4 rows=1
                                    wrap="physical"><?php echo $this->_tpl_vars['roomprefix']; ?>
</textarea></td>
...
">
    ...
    <div class="col-sm-4" style="margin-top: 350px;">
        <div class="col-md-6">
            <?php echo $this->_tpl_vars['addWardForm']; ?>
