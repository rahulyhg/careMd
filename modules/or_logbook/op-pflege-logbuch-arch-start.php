...
if ($datafound) {
        ...
        for ($n = 0; $n < sizeof($ebuf); $n++) {
            ...
            for ($i = 0; $i < sizeof($dbuf); $i++) {
                ...
                if ($elems[n] == "")
                    ...
                    echo '&nbsp;' . $elems[n] . " " . $tbuf[$n] . $elems[x] . "<br>";
            }
        }
        ...
        if ($pdata[an_doctor]) {
            ...
            for ($i = 0; $i < sizeof($dbuf); $i++) {
                ...
                if ($elems[n] == "")
                    ...
                    echo '&nbsp;' . $elems[n] . ' ' . $LDAnaPrefix . $elems[x] . '<br>';
            }
            echo '</font>';
        }
        /*
    ...
    if ($thisday != $today) {
        ...
        if ($nofile)
            echo '<p><b><font color="#800000" size=4>' . $LDPatNoExist . '</b>';
    }
    //echo '
    //<br><p>
