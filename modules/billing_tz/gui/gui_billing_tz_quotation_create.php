...
<BODY bgcolor="#ffffff" link="#000066" alink="#cc0000" vlink="#000066" onLoad="setBallon('BallonTip', '', '')" >
    ...
    <script language="javascript">
        ...
        function chkform(form) {
            ...
            var deposit_balance;
            var clearcheck;
            var ins_id =<?php echo $ins_id; ?>;
            var is_discharged;
            var bankid;
            var bank_enabled=<?php echo $bank_enabled;?>;
            ...
            is_discharged = document.getElementById('discharged');
            bankid=document.getElementById('bankid');


             

           if (insurance.value != ins_id) {

                alert("PLEASE SELECT THE CORRECT INSURANCE FOR THIS PATIENT OR NON-CASH FOR CASH-PATIENT");
                return false;

            }else 
                if (balance.value !== "" && clearcheck.checked == false) {
                alert("PLEASE TICK CLEAR BALANCE AND SAVE THE BILL");
                return false;
            }else
            if(bank_enabled=='1' && ins_id=='0'){
                if(bankid.value==""){
            ...
            if (clearcheck.checked)
            {
                ...
                if (is_discharged.value == 0) {
                    alert("Discharge this Patient First and try again");
                    return false;
                }
            }
