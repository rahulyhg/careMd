...
if (isset($_GET['bill_number'])) {
    $sql = 'SELECT encounter_nr,description,price,amount,is_paid,ID '
            . ' FROM care_tz_billing b INNER JOIN care_tz_billing_elem be '
            . ' ON b.nr=be.nr where b.nr=' . $_GET['bill_number'];
