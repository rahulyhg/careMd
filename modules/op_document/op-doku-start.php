  ...
  <td colspan=6 height=1><img src="' . $root_path . 'gui/img/common/default/pixel.gif" border=0 width=1 height=1 align="absmiddle"></td>
	...
	<input name="operator" type="text" size="25" value="';
        ...
        ?>
                                ...
                                <tr <?php if ($mode == 'saveok') echo "bgcolor=#ffffff"; ?>>
                                    <td background="<?php echo $bg_img; ?>"><FONT <?php if ($err_gebdatum) echo 'color=#cc0000'; ?>><?php echo $LDSex ?>:
                                    </td>
                                    <td><FONT color="#000099">
        <?php
        echo ($result['sex']);
        ...
        ?>
                                ...
                                <tr <?php if ($mode == 'saveok') echo "bgcolor=#ffffff"; ?>>
                                    <td background="<?php echo $bg_img; ?>"><FONT  color=red><?php if ($err_indication) echo '*'; ?><?php echo $LDIndication ?>:
                                    </td>
                                    <td>
                                ...
                                <tr <?php if ($mode == 'saveok') echo "bgcolor=#ffffff"; ?>>
                                    <td background="<?php echo $bg_img; ?>"><FONT  color=red><?php if ($err_procedure_or) echo '*'; ?><?php echo $LDProcedure ?>:
                                    </td>
                                    <td>
