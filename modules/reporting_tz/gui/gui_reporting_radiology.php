...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
    ...
    <?php
$rep_obj->Radiology_Revenue($_GET['start'], $_GET['end'], $_GET['company'], $_GET['in_out_patient'], $_GET['dept_nr'], $_GET['insurance'], 1);
     exit();
}
?>
...
<!-- 
            ...
            {
                urlholder = "./reporting_radiology.php?printout=TRUE&start=<?php echo $selected_date_from; ?>&end=<?php echo $selected_date_to; ?>&company=<?php echo $company; ?>&in_out_patient=" + admission_id + "&dept_nr=" + dept + "&insurance=" + insurance;
                        ...
                        <table cellspacing="0"  class="titlebar" border=0>
                            <tr valign=top  class="titlebar" >
                                <td width="300" bgcolor="#99ccff" >
                                    &nbsp;&nbsp;<font color="#330066"><?php echo $LDRadRevReport; ?></font></td>
  ...
  ?>
                        ...
                        <form name="form1" method="post" action="" onSubmit="javascript:validate()">        
                            ...
                            if (isset($_POST['show'])) {
                                ...
                                $rep_obj->Radiology_Revenue($selected_date_from, $selected_date_to, $company, $_POST['admission_id']);
                            }
                            ?>
                            <!-- &nbsp;&nbsp;
