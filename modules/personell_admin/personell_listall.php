...
$sql = "SELECT ps.pid, ps.nr, ps.is_discharged, UPPER(p.name_last) as name_last, CONCAT(p.name_first,' ', p.name_2) AS name_first, p.date_birth, p.addr_zip, p.sex, p.photo_filename";
