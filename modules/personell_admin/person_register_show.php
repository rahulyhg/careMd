...
if ((!isset($pid) || !$pid) && $HTPP_SESSION_VARS['sess_pid'])
    $pid = $HTPP_SESSION_VARS['sess_pid'];
        ...
        <td colspan=3>
            ...
            <p>
                ...
                <?php if (!$newdata) { ?>
                    ...
                    <?php
                    if ($target == "search")
                        $newsearchfile = 'personell_search.php' . URL_APPEND . '&target=personell_search';
                    else
                        $newsearchfile = 'personell_register_search.php' . URL_APPEND . '&target=person_reg';
                    ?>
