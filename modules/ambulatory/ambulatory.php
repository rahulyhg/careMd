...
if (!$_SESSION['sess_path_referer'])
    $_SESSION['sess_path_referrer'] = "sess_path_referrer";
...
//	
    ...
    $smarty->assign('sOutPatientLink', "<a href=\"amb_clinic_patients_pass.php" . URL_APPEND . "&target=list&dept_nr=" . $v['nr'] . "&dept=" . strtr($v['name_formal'], ' ', '+') . "\">$LDOutpatientClinic</a>");
