...
# Body Onload js
if ($mode != "pwchg")
    $smarty->assign('sOnLoadJs', 'onLoad="document.pwchanger.userid.focus()"');
...
<script language=javascript>
    ...
    {
        return true;
        if ((d.userid.value == "") || (d.keyword.value == "") || (d.n.value == "") || (d.n2.value == ""))
            return false;
        if (d.n.value != d.n2.value) {
            alert("<?php echo $LDAlertPwError ?>");
            return false;
        }
        return true;
    }
...
<?php endif; ?>
    ...
    <p>
        ...
        <a href="<?php echo $breakfile; ?>"><img <?php if ($mode == 'pwchg') echo createLDImgSrc($root_path, 'close2.gif', '0');
