...
<ul>
    ...
    <form action="dept_new.php" method="post" name="newstat" ENCTYPE="multipart/form-data" onSubmit="return chkForm(this)">
        <table border=0>
            ...
            <tr>
                <td class=pblock align=right bgColor="#eeeeee"><?php echo 'Maximum Daily Appointments' ?>: </td>
                <td class=pblock><input type="text" name="max_appointments" size=40 maxlength=40 value="<?php echo $max_appointments ?>"><br>
                </td>
            </tr>
