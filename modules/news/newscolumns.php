...
if (empty($user_origin))
    $user_origin = $_SESSION['sess_user_origin'];
...
if ($dblink_ok) {
    ...
    if (!$news_dept_max_display)
        $news_num_stop = 4; // default is 3
    else
        $news_num_stop = $news_dept_max_display;  // The maximum number of news article to be displayed
