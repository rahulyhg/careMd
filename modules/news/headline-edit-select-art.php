...
if ($_SESSION['sess_file_return'] == $thisfile)
    $returnfile = 'start_page.php' . URL_APPEND;
else
    $returnfile = $root_path . $_SESSION['sess_file_return'] . URL_APPEND;
...
<?php echo setCharSet(); ?>
    ...
    <script language="javascript">
        function chkForm(d)
        {
            if ((d.artopt[0].checked) || (d.artopt[1].checked) || (d.artopt[2].checked))
                return true;
            else
                return false;
        }
