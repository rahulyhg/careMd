...
if ($_POST['submit'] == 'submit') {
    ...
    $db->Execute($sql);
       ...
       // Insert Values for 8th row:
    $db_buffer['ShowDescription'] = $_POST['short_8'];
    $db_buffer['FullDescription'] = $_POST['long_8'];
    if ($_POST['is_insurance'] == 8) {
        $is_insured_8 = 1;
        $db_buffer['is_insurance_price'] = 1;
    } else {
        $db_buffer['is_insurance_price'] = 0;
    ...
    $db->Execute($sql);
     ...
     // Insert Values for 9th row:
    $db_buffer['ShowDescription'] = $_POST['short_9'];
    $db_buffer['FullDescription'] = $_POST['long_9'];
    if ($_POST['is_insurance'] == 9) {
        $is_insured_9 = 1;
        $db_buffer['is_insurance_price'] = 1;
    } else {
        $db_buffer['is_insurance_price'] = 0;
    ...
    $db->Execute($sql);
     ...
     // Insert Values for 10th row:
    $db_buffer['ShowDescription'] = $_POST['short_10'];
    $db_buffer['FullDescription'] = $_POST['long_10'];
    if ($_POST['is_insurance'] == 10) {
        $is_insured_10 = 1;
        $db_buffer['is_insurance_price'] = 1;
    } else {
        $db_buffer['is_insurance_price'] = 0;
    ...
    $db->Execute($sql);
     ...
     // Insert Values for 11th row:
    $db_buffer['ShowDescription'] = $_POST['short_11'];
    $db_buffer['FullDescription'] = $_POST['long_11'];
    if ($_POST['is_insurance'] == 11) {
        $is_insured_11 = 1;
        $db_buffer['is_insurance_price'] = 1;
    } else {
        $db_buffer['is_insurance_price'] = 0;
    ...
    $db->Execute($sql);
     ...
     // Insert Values for 12th row:
    $db_buffer['ShowDescription'] = $_POST['short_12'];
    $db_buffer['FullDescription'] = $_POST['long_12'];
    if ($_POST['is_insurance'] == 12) {
        $is_insured_12 = 1;
        $db_buffer['is_insurance_price'] = 1;
    } else {
        $db_buffer['is_insurance_price'] = 0;
