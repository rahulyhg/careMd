...
if (isset($mode) && $mode == 'save') {
    ...
    if (!is_numeric($_POST['news_headline_title_font_size']))
        $_POST['news_headline_title_font_size'] = NEWS_TITLE_SIZE;
    if (empty($_POST['news_headline_title_font_face']))
        $_POST['news_headline_title_font_face'] = NEWS_TITLE_FONT;
    if (!is_numeric($_POST['news_headline_preface_font_size']))
        $_POST['news_headline_preface_font_size'] = NEWS_PREFACE_SIZE;
    if (empty($_POST['news_headline_preface_font_face']))
        $_POST['news_headline_preface_font_face'] = NEWS_PREFACE_FONT;
    if (!is_numeric($_POST['news_headline_body_font_size']))
        $_POST['news_headline_body_font_size'] = NEWS_BODY_SIZE;
    if (empty($_POST['news_headline_body_font_face']))
        $_POST['news_headline_body_font_face'] = NEWS_BODY_FONT;
...
<!-- Script Begin
    function useDefault() {
        ...
        if (tb == "1")
            d.news_headline_title_font_bold[0].checked = true;
        else
            d.news_headline_title_font_bold[1].checked = true;
        ...
        if (pb == "1")
            d.news_headline_preface_font_bold[0].checked = true;
        else
            d.news_headline_preface_font_bold[1].checked = true;
...
<?php echo $LDNoteDefault ?>
    <form action="<?php echo $thisfile ?>" method="post" name="newsdisplay">
        ...
        <p>
<?php if ($item_no) $save_button = 'update.gif';
else $save_button = 'savedisc.gif'; ?>
