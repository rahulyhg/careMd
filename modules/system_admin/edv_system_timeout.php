...
if (isset($mode) && $mode == 'save') {
    ...
    if (!is_numeric($_POST['thours']) || $_POST['thours'] > 24)
        $_POST['thours'] = 0;
    if (!is_numeric($_POST['tmins']) || $_POST['tmins'] > 59 || $_POST['tmins'] < 1)
        $_POST['tmins'] = $def_max_mins;
    if (!is_numeric($_POST['tsecs']) || $_POST['tsecs'] > 59)
        $_POST['tsecs'] = $def_max_tsecs;
