...
if (!empty($ipath)) {
    switch ($ipath) {
        case 'menu': $breakfile = "doctors.php" . URL_APPEND;
            break;
        case 'qview': $breakfile = "doctors-dienst-schnellsicht.php" . URL_APPEND . "&hilitedept=$dept_nr";
            break;
        case 'plan': $breakfile = "doctors-dienstplan-planen.php" . URL_APPEND . "&dept_nr=$dept_nr&pmonth=$pmonth&pyear=$pyear&retpath=$retpath";
            break;
    ...
    <p><br>
        ...
        <!--     <td  align=center  class="v13" colspan=2><font><nobr>&nbsp;<?php echo $LDDateOfBirth; ?></nobr></td>
            ...
            <td  align=center  class="v13" colspan=2><nobr>&nbsp;</nobr></td>
                ...
                <td  class="v13" colspan=2><nobr><fon >&nbsp;<?php echo ucwords($row['name_first']); ?></nobr></td>
