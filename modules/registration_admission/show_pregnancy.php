...
if (!isset($mode)) {
    ...
    if (empty($_POST['delivery_date']))
        ...
        $_POST['delivery_date'] = @formatDate2STD($_POST['delivery_date'], $date_format);
    if (empty($_POST['delivery_time']))
        $_POST['delivery_time'] = date('H:i:s');
    else
        $_POST['delivery_time'] = @convertTimeToStandard($_POST['delivery_time']);
