...
use CareMd\CareMd\CareTzMtuhaCatKey;
use CareMd\CareMd\CareTzMtuhaCatKeyQuery;
...
class CareTzMtuhaCatKeyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTzMtuhaCatKeyTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTzMtuhaCatKey';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTzMtuhaCatKey';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTzMtuhaCatKey');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTzMtuhaCatKey) { // it's a model object
