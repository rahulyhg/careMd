...
use CareMd\CareMd\CareTypeDischarge;
use CareMd\CareMd\CareTypeDischargeQuery;
...
class CareTypeDischargeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTypeDischargeTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTypeDischarge';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTypeDischarge';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTypeDischarge');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTypeDischarge) { // it's a model object
