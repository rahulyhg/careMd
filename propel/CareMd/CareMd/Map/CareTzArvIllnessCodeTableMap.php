...
use CareMd\CareMd\CareTzArvIllnessCode;
use CareMd\CareMd\CareTzArvIllnessCodeQuery;
...
class CareTzArvIllnessCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTzArvIllnessCodeTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTzArvIllnessCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTzArvIllnessCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTzArvIllnessCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTzArvIllnessCode) { // it's a model object
