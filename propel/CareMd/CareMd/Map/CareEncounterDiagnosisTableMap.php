...
use CareMd\CareMd\CareEncounterDiagnosis;
use CareMd\CareMd\CareEncounterDiagnosisQuery;
...
class CareEncounterDiagnosisTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareEncounterDiagnosisTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareEncounterDiagnosis';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareEncounterDiagnosis';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareEncounterDiagnosis');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareEncounterDiagnosis) { // it's a model object
