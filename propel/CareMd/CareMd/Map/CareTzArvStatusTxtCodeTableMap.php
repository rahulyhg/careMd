...
use CareMd\CareMd\CareTzArvStatusTxtCode;
use CareMd\CareMd\CareTzArvStatusTxtCodeQuery;
...
class CareTzArvStatusTxtCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTzArvStatusTxtCodeTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTzArvStatusTxtCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTzArvStatusTxtCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTzArvStatusTxtCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTzArvStatusTxtCode) { // it's a model object
