...
class CareTzWardTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTzWardTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTzWard';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTzWard';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTzWard');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTzWard) { // it's a model object
