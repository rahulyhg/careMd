...
use CareMd\CareMd\CareTzArvStatusTxt;
use CareMd\CareMd\CareTzArvStatusTxtQuery;
...
class CareTzArvStatusTxtTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'CareMd.CareMd.Map.CareTzArvStatusTxtTableMap';
     ...
     */
    const OM_CLASS = '\\CareMd\\CareMd\\CareTzArvStatusTxt';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CareMd.CareMd.CareTzArvStatusTxt';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CareMd\\CareMd\\CareTzArvStatusTxt');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CareMd\CareMd\CareTzArvStatusTxt) { // it's a model object
