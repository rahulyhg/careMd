...
abstract class CareTzEyeEyelids implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CareMd\\CareMd\\Map\\CareTzEyeEyelidsTableMap';
    ...
    /**
     * Initializes internal state of CareMd\CareMd\Base\CareTzEyeEyelids object.
     */
     ...
     * @return $this|\CareMd\CareMd\CareTzEyeEyelids The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CareMd\\CareMd\\CareTzEyeEyelids'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CareMd\CareMd\CareTzEyeEyelids
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CareMd\CareMd\CareTzEyeEyelids The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CareMd\CareMd\CareTzEyeEyelids (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CareMd\CareMd\CareTzEyeEyelids Clone of current object.
     * @throws PropelException
     */
