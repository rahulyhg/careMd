...
abstract class CareTestFindingsRadio implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CareMd\\CareMd\\Map\\CareTestFindingsRadioTableMap';
    ...
    /**
     * Initializes internal state of CareMd\CareMd\Base\CareTestFindingsRadio object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\CareMd\CareMd\CareTestFindingsRadio The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CareMd\\CareMd\\CareTestFindingsRadio'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CareMd\CareMd\CareTestFindingsRadio
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CareMd\CareMd\CareTestFindingsRadio The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CareMd\CareMd\CareTestFindingsRadio (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CareMd\CareMd\CareTestFindingsRadio Clone of current object.
     * @throws PropelException
     */
