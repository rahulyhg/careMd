...
use \Exception;
use \PDO;
use CareMd\CareMd\CareTypeTest as ChildCareTypeTest;
...
abstract class CareTypeTestQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CareMd\CareMd\Base\CareTypeTestQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\CareMd\\CareMd\\CareTypeTest', $modelAlias = null)
    {
