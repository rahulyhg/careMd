...
abstract class CareTzEyePosteriorSegment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CareMd\\CareMd\\Map\\CareTzEyePosteriorSegmentTableMap';
    ...
    /**
     * Initializes internal state of CareMd\CareMd\Base\CareTzEyePosteriorSegment object.
     */
     ...
     * @return $this|\CareMd\CareMd\CareTzEyePosteriorSegment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CareMd\\CareMd\\CareTzEyePosteriorSegment'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CareMd\CareMd\CareTzEyePosteriorSegment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CareMd\CareMd\CareTzEyePosteriorSegment The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CareMd\CareMd\CareTzEyePosteriorSegment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CareMd\CareMd\CareTzEyePosteriorSegment Clone of current object.
     * @throws PropelException
     */
