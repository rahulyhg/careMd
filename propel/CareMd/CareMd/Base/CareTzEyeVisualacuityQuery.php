...
use \Exception;
use \PDO;
use CareMd\CareMd\CareTzEyeVisualacuity as ChildCareTzEyeVisualacuity;
...
abstract class CareTzEyeVisualacuityQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CareMd\CareMd\Base\CareTzEyeVisualacuityQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\CareMd\\CareMd\\CareTzEyeVisualacuity', $modelAlias = null)
    {
