...
use propel\propel\CareMedReportQuery as ChildCareMedReportQuery;
use propel\propel\Map\CareMedReportTableMap;

/**
 * Base class that represents a row from the 'care_med_report' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareMedReport implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareMedReportTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareMedReport object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareMedReport</code> instance.  If
     * <code>obj</code> is an instance of <code>CareMedReport</code>, delegates to
     * <code>equals(CareMedReport)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareMedReport The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareMedReport The current object (for fluent API support)
     */
    public function setReportNr($v)
    {
        ...
        if ($this->report_nr !== $v) {
            $this->report_nr = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_REPORT_NR] = true;
        }
    ...
    public function setDept($v)
    {
        ...
        if ($this->dept !== $v) {
            $this->dept = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_DEPT] = true;
        }
    ...
    public function setReport($v)
    {
        ...
        if ($this->report !== $v) {
            $this->report = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_REPORT] = true;
        }
    ...
    public function setReporter($v)
    {
        ...
        if ($this->reporter !== $v) {
            $this->reporter = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_REPORTER] = true;
        }
    ...
    /**
     * Set the value of [id_nr] column.
     *
     * @param string $v new value
     * @return $this|\propel\propel\CareMedReport The current object (for fluent API support)
     */
    public function setIdNr($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->id_nr !== $v) {
            $this->id_nr = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_ID_NR] = true;
        }
    ...
    public function setReportDate($v)
    {
        ...
        if ($this->report_date !== null || $dt !== null) {
            if ( ($dt != $this->report_date) // normalized values don't match
                ...
                $this->modifiedColumns[CareMedReportTableMap::COL_REPORT_DATE] = true;
            }
    ...
    public function setReportTime($v)
    {
        ...
        if ($this->report_time !== null || $dt !== null) {
            if ( ($dt != $this->report_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareMedReportTableMap::COL_REPORT_TIME] = true;
            }
        } // if either are not null
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_HISTORY] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CareMedReportTableMap::COL_MODIFY_TIME] = true;
            }
        } // if either are not null
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CareMedReportTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareMedReportTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareMedReportTableMap::translateFieldName('ReportNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->report_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareMedReportTableMap::translateFieldName('Dept', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareMedReportTableMap::translateFieldName('Report', TableMap::TYPE_PHPNAME, $indexType)];
            $this->report = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareMedReportTableMap::translateFieldName('Reporter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reporter = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareMedReportTableMap::translateFieldName('IdNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_nr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareMedReportTableMap::translateFieldName('ReportDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->report_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareMedReportTableMap::translateFieldName('ReportTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->report_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareMedReportTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareMedReportTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareMedReportTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareMedReportTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareMedReportTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareMedReportTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 13; // 13 = CareMedReportTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareMedReport'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareMedReportQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareMedReport::setDeleted()
     * @see CareMedReport::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareMedReportQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareMedReportTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_NR)) {
            $modifiedColumns[':p' . $index++]  = 'report_nr';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_DEPT)) {
            $modifiedColumns[':p' . $index++]  = 'dept';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT)) {
            $modifiedColumns[':p' . $index++]  = 'report';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORTER)) {
            $modifiedColumns[':p' . $index++]  = 'reporter';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_ID_NR)) {
            $modifiedColumns[':p' . $index++]  = 'id_nr';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'report_date';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'report_time';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }

        $sql = sprintf(
            'INSERT INTO care_med_report (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'reporter':
                        ...
                        break;
                    case 'id_nr':
                        $stmt->bindValue($identifier, $this->id_nr, PDO::PARAM_STR);
                        break;
                    case 'report_date':
    ...
    {
        $pos = CareMedReportTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareMedReport'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareMedReport'][$this->hashCode()] = true;
        $keys = CareMedReportTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getReportNr(),
            $keys[1] => $this->getDept(),
            $keys[2] => $this->getReport(),
            $keys[3] => $this->getReporter(),
            $keys[4] => $this->getIdNr(),
            $keys[5] => $this->getReportDate(),
            $keys[6] => $this->getReportTime(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareMedReport
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setReport($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setReporter($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setIdNr($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setReportDate($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setReportTime($arr[$keys[6]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareMedReport The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_NR)) {
            $criteria->add(CareMedReportTableMap::COL_REPORT_NR, $this->report_nr);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_DEPT)) {
            $criteria->add(CareMedReportTableMap::COL_DEPT, $this->dept);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT)) {
            $criteria->add(CareMedReportTableMap::COL_REPORT, $this->report);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORTER)) {
            $criteria->add(CareMedReportTableMap::COL_REPORTER, $this->reporter);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_ID_NR)) {
            $criteria->add(CareMedReportTableMap::COL_ID_NR, $this->id_nr);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_DATE)) {
            $criteria->add(CareMedReportTableMap::COL_REPORT_DATE, $this->report_date);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_REPORT_TIME)) {
            $criteria->add(CareMedReportTableMap::COL_REPORT_TIME, $this->report_time);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_STATUS)) {
            $criteria->add(CareMedReportTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_HISTORY)) {
            $criteria->add(CareMedReportTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_MODIFY_ID)) {
            $criteria->add(CareMedReportTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CareMedReportTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_CREATE_ID)) {
            $criteria->add(CareMedReportTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CareMedReportTableMap::COL_CREATE_TIME)) {
            $criteria->add(CareMedReportTableMap::COL_CREATE_TIME, $this->create_time);
        }
    ...
    {
        $criteria = ChildCareMedReportQuery::create();
        $criteria->add(CareMedReportTableMap::COL_REPORT_NR, $this->report_nr);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareMedReport (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareMedReport Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareMedReportTableMap::DEFAULT_STRING_FORMAT);
    }
