...
use propel\propel\CareTestFindingsBaclaborQuery as ChildCareTestFindingsBaclaborQuery;
use propel\propel\Map\CareTestFindingsBaclaborTableMap;
...
abstract class CareTestFindingsBaclabor implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTestFindingsBaclaborTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTestFindingsBaclabor object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTestFindingsBaclabor The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTestFindingsBaclabor'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTestFindingsBaclabor
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTestFindingsBaclabor The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTestFindingsBaclabor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTestFindingsBaclabor Clone of current object.
     * @throws PropelException
     */
