...
use propel\propel\CareTzEyeOpticDiscQuery as ChildCareTzEyeOpticDiscQuery;
use propel\propel\Map\CareTzEyeOpticDiscTableMap;

/**
 * Base class that represents a row from the 'care_tz_eye_optic_disc' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTzEyeOpticDisc implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzEyeOpticDiscTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzEyeOpticDisc object.
     */
    ...
    /**
     * Compares this with another <code>CareTzEyeOpticDisc</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTzEyeOpticDisc</code>, delegates to
     * <code>equals(CareTzEyeOpticDisc)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTzEyeOpticDisc The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTzEyeOpticDisc The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_ID] = true;
        }
    ...
    public function setPid($v)
    {
        ...
        if ($this->pid !== $v) {
            $this->pid = $v;
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_PID] = true;
        }
    ...
    public function setRightEyeTest1($v)
    {
        ...
        if ($this->right_eye_test1 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST1] = true;
        }
    ...
    public function setRightEyeTest2($v)
    {
        ...
        if ($this->right_eye_test2 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST2] = true;
        }
    ...
    public function setRightEyeTest3($v)
    {
        ...
        if ($this->right_eye_test3 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST3] = true;
        }
    ...
    public function setRightEyeTest4($v)
    {
        ...
        if ($this->right_eye_test4 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST4] = true;
        }
    ...
    public function setRightEyeTest5($v)
    {
        ...
        if ($this->right_eye_test5 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST5] = true;
        }
    ...
    public function setRightEyeTest6($v)
    {
        ...
        if ($this->right_eye_test6 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST6] = true;
        }
    ...
    public function setLeftEyeTest1($v)
    {
        ...
        if ($this->left_eye_test1 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST1] = true;
        }
    ...
    public function setLeftEyeTest2($v)
    {
        ...
        if ($this->left_eye_test2 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST2] = true;
        }
    ...
    public function setLeftEyeTest3($v)
    {
        ...
        if ($this->left_eye_test3 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST3] = true;
        }
    ...
    public function setLeftEyeTest4($v)
    {
        ...
        if ($this->left_eye_test4 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST4] = true;
        }
    ...
    public function setLeftEyeTest5($v)
    {
        ...
        if ($this->left_eye_test5 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST5] = true;
        }
    ...
    public function setLeftEyeTest6($v)
    {
        ...
        if ($this->left_eye_test6 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST6] = true;
        }
    ...
    public function setSignature($v)
    {
        ...
        if ($this->signature !== $v) {
            $this->signature = $v;
            $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_SIGNATURE] = true;
        }
    ...
    public function setExaminationDate($v)
    {
        ...
        if ($this->examination_date !== null || $dt !== null) {
            if ($this->examination_date === null || $dt === null || $dt->format("Y-m-d") !== $this->examination_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[CareTzEyeOpticDiscTableMap::COL_EXAMINATION_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('Pid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('RightEyeTest6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('LeftEyeTest6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('Signature', TableMap::TYPE_PHPNAME, $indexType)];
            $this->signature = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CareTzEyeOpticDiscTableMap::translateFieldName('ExaminationDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 16; // 16 = CareTzEyeOpticDiscTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzEyeOpticDisc'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTzEyeOpticDiscQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTzEyeOpticDisc::setDeleted()
     * @see CareTzEyeOpticDisc::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTzEyeOpticDiscQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTzEyeOpticDiscTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_PID)) {
            $modifiedColumns[':p' . $index++]  = 'pid';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST1)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test1';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST2)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test2';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST3)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test3';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST4)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test4';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST5)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test5';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST6)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test6';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST1)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test1';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST2)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test2';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST3)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test3';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST4)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test4';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST5)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test5';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST6)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test6';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = 'Signature';
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_EXAMINATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'Examination_date';
        }

        $sql = sprintf(
            'INSERT INTO care_tz_eye_optic_disc (%s) VALUES (%s)',
    ...
    {
        $pos = CareTzEyeOpticDiscTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTzEyeOpticDisc'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTzEyeOpticDisc'][$this->hashCode()] = true;
        $keys = CareTzEyeOpticDiscTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPid(),
            ...
            $keys[8] => $this->getLeftEyeTest1(),
            $keys[9] => $this->getLeftEyeTest2(),
            $keys[10] => $this->getLeftEyeTest3(),
            $keys[11] => $this->getLeftEyeTest4(),
            $keys[12] => $this->getLeftEyeTest5(),
            $keys[13] => $this->getLeftEyeTest6(),
            $keys[14] => $this->getSignature(),
            $keys[15] => $this->getExaminationDate(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzEyeOpticDisc
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) {
            $this->setLeftEyeTest1($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setLeftEyeTest2($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setLeftEyeTest3($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setLeftEyeTest4($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setLeftEyeTest5($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setLeftEyeTest6($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setSignature($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setExaminationDate($arr[$keys[15]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzEyeOpticDisc The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_ID)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_PID)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_PID, $this->pid);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST1)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST1, $this->right_eye_test1);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST2)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST2, $this->right_eye_test2);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST3)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST3, $this->right_eye_test3);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST4)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST4, $this->right_eye_test4);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST5)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST5, $this->right_eye_test5);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST6)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_RIGHT_EYE_TEST6, $this->right_eye_test6);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST1)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST1, $this->left_eye_test1);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST2)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST2, $this->left_eye_test2);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST3)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST3, $this->left_eye_test3);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST4)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST4, $this->left_eye_test4);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST5)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST5, $this->left_eye_test5);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST6)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_LEFT_EYE_TEST6, $this->left_eye_test6);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_SIGNATURE)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_SIGNATURE, $this->signature);
        }
        if ($this->isColumnModified(CareTzEyeOpticDiscTableMap::COL_EXAMINATION_DATE)) {
            $criteria->add(CareTzEyeOpticDiscTableMap::COL_EXAMINATION_DATE, $this->examination_date);
        }
    ...
    {
        $criteria = ChildCareTzEyeOpticDiscQuery::create();
        $criteria->add(CareTzEyeOpticDiscTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzEyeOpticDisc (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzEyeOpticDisc Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTzEyeOpticDiscTableMap::DEFAULT_STRING_FORMAT);
    }
