...
use propel\propel\CareTzArvReferredFromCode as ChildCareTzArvReferredFromCode;
...
abstract class CareTzArvReferredFromCodeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzArvReferredFromCodeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzArvReferredFromCode', $modelAlias = null)
    {
