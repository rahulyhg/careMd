...
use propel\propel\CareTzArvRegistrationQuery as ChildCareTzArvRegistrationQuery;
use propel\propel\Map\CareTzArvRegistrationTableMap;
...
abstract class CareTzArvRegistration implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzArvRegistrationTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzArvRegistration object.
     */
     ...
     * @return $this|\propel\propel\CareTzArvRegistration The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzArvRegistration'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzArvRegistration
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzArvRegistration The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzArvRegistration (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzArvRegistration Clone of current object.
     * @throws PropelException
     */
