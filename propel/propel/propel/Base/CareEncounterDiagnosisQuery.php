...
use propel\propel\CareEncounterDiagnosis as ChildCareEncounterDiagnosis;
...
abstract class CareEncounterDiagnosisQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareEncounterDiagnosisQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareEncounterDiagnosis', $modelAlias = null)
    {
