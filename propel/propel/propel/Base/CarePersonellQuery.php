...
use propel\propel\CarePersonell as ChildCarePersonell;
...
abstract class CarePersonellQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CarePersonellQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CarePersonell', $modelAlias = null)
    {
