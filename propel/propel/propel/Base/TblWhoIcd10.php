...
use propel\propel\TblWhoIcd10Query as ChildTblWhoIcd10Query;
use propel\propel\Map\TblWhoIcd10TableMap;
...
abstract class TblWhoIcd10 implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\TblWhoIcd10TableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\TblWhoIcd10 object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\TblWhoIcd10 The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\TblWhoIcd10'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\TblWhoIcd10
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\TblWhoIcd10 The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\TblWhoIcd10 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\TblWhoIcd10 Clone of current object.
     * @throws PropelException
     */
