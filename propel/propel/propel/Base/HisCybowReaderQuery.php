...
use propel\propel\HisCybowReader as ChildHisCybowReader;
...
abstract class HisCybowReaderQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\HisCybowReaderQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\HisCybowReader', $modelAlias = null)
    {
