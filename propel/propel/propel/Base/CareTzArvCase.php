...
use propel\propel\CareTzArvCaseQuery as ChildCareTzArvCaseQuery;
use propel\propel\Map\CareTzArvCaseTableMap;
...
abstract class CareTzArvCase implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzArvCaseTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzArvCase object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTzArvCase The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzArvCase'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzArvCase
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzArvCase The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzArvCase (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzArvCase Clone of current object.
     * @throws PropelException
     */
