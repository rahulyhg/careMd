...
use propel\propel\CareDutyplanOncallQuery as ChildCareDutyplanOncallQuery;
use propel\propel\Map\CareDutyplanOncallTableMap;
...
abstract class CareDutyplanOncall implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareDutyplanOncallTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareDutyplanOncall object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareDutyplanOncall The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareDutyplanOncall'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareDutyplanOncall
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareDutyplanOncall The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareDutyplanOncall (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareDutyplanOncall Clone of current object.
     * @throws PropelException
     */
