...
use propel\propel\CareUsers as ChildCareUsers;
...
abstract class CareUsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareUsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareUsers', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT name, login_id, password, personell_nr, lockflag, role_id, exc, s_date, s_time, expire_date, expire_time, status, history, modify_id, modify_time, create_id, create_time FROM care_users WHERE login_id = :p0';
        try {
