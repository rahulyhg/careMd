...
use propel\propel\CareTzDrugliststrucQuery as ChildCareTzDrugliststrucQuery;
use propel\propel\Map\CareTzDrugliststrucTableMap;

/**
 * Base class that represents a row from the 'care_tz_drugliststruc' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTzDrugliststruc implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzDrugliststrucTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzDrugliststruc object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareTzDrugliststruc</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTzDrugliststruc</code>, delegates to
     * <code>equals(CareTzDrugliststruc)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTzDrugliststruc The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTzDrugliststruc The current object (for fluent API support)
     */
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_ITEM_ID] = true;
        }
    ...
    public function setItemNumber($v)
    {
        ...
        if ($this->item_number !== $v) {
            $this->item_number = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_ITEM_NUMBER] = true;
        }
    ...
    public function setIsPediatric($v)
    {
        ...
        if ($this->is_pediatric !== $v) {
            $this->is_pediatric = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_IS_PEDIATRIC] = true;
        }
    ...
    public function setIsAdult($v)
    {
        ...
        if ($this->is_adult !== $v) {
            $this->is_adult = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_IS_ADULT] = true;
        }
    ...
    public function setIsOther($v)
    {
        ...
        if ($this->is_other !== $v) {
            $this->is_other = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_IS_OTHER] = true;
        }
    ...
    public function setIsConsumable($v)
    {
        ...
        if ($this->is_consumable !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_IS_CONSUMABLE] = true;
        }
    ...
    public function setMemsItemCode($v)
    {
        ...
        if ($this->mems_item_code !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_MEMS_ITEM_CODE] = true;
        }
    ...
    public function setMemsItemDescription($v)
    {
        ...
        if ($this->mems_item_description !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_MEMS_ITEM_DESCRIPTION] = true;
        }
    ...
    public function setMemsPackSize($v)
    {
        ...
        if ($this->mems_pack_size !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_MEMS_PACK_SIZE] = true;
        }
    ...
    public function setMemsPricePerPackSize($v)
    {
        ...
        if ($this->mems_price_per_pack_size !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_MEMS_PRICE_PER_PACK_SIZE] = true;
        }
    ...
    public function setMemsSizes($v)
    {
        ...
        if ($this->mems_sizes !== $v) {
            $this->mems_sizes = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_MEMS_SIZES] = true;
        }
    ...
    public function setItemDescription($v)
    {
        ...
        if ($this->item_description !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_ITEM_DESCRIPTION] = true;
        }
    ...
    public function setItemFullDescription($v)
    {
        ...
        if ($this->item_full_description !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_ITEM_FULL_DESCRIPTION] = true;
        }
    ...
    public function setDosage($v)
    {
        ...
        if ($this->dosage !== $v) {
            $this->dosage = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_DOSAGE] = true;
        }
    ...
    public function setUnitPrice($v)
    {
        ...
        if ($this->unit_price !== $v) {
            $this->unit_price = $v;
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_UNIT_PRICE] = true;
        }
    ...
    public function setPurchasingClass($v)
    {
        ...
        if ($this->purchasing_class !== $v) {
            ...
            $this->modifiedColumns[CareTzDrugliststrucTableMap::COL_PURCHASING_CLASS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('ItemNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('IsPediatric', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_pediatric = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('IsAdult', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_adult = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('IsOther', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_other = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('IsConsumable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_consumable = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('MemsItemCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mems_item_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('MemsItemDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mems_item_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('MemsPackSize', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mems_pack_size = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('MemsPricePerPackSize', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mems_price_per_pack_size = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('MemsSizes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mems_sizes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('ItemDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('ItemFullDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_full_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('Dosage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dosage = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('UnitPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CareTzDrugliststrucTableMap::translateFieldName('PurchasingClass', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 16; // 16 = CareTzDrugliststrucTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzDrugliststruc'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTzDrugliststrucQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTzDrugliststruc::setDeleted()
     * @see CareTzDrugliststruc::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTzDrugliststrucQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTzDrugliststrucTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'item_id';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'item_number';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_PEDIATRIC)) {
            $modifiedColumns[':p' . $index++]  = 'is_pediatric';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_ADULT)) {
            $modifiedColumns[':p' . $index++]  = 'is_adult';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_OTHER)) {
            $modifiedColumns[':p' . $index++]  = 'is_other';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_CONSUMABLE)) {
            $modifiedColumns[':p' . $index++]  = 'is_consumable';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'mems_item_code';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'mems_item_description';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_PACK_SIZE)) {
            $modifiedColumns[':p' . $index++]  = 'mems_pack_size';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_PRICE_PER_PACK_SIZE)) {
            $modifiedColumns[':p' . $index++]  = 'mems_price_per_pack_size';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_SIZES)) {
            $modifiedColumns[':p' . $index++]  = 'mems_sizes';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'item_description';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_FULL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'item_full_description';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_DOSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'dosage';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_UNIT_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'unit_price';
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_PURCHASING_CLASS)) {
            $modifiedColumns[':p' . $index++]  = 'purchasing_class';
        }

        $sql = sprintf(
            'INSERT INTO care_tz_drugliststruc (%s) VALUES (%s)',
    ...
    {
        $pos = CareTzDrugliststrucTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTzDrugliststruc'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTzDrugliststruc'][$this->hashCode()] = true;
        $keys = CareTzDrugliststrucTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzDrugliststruc
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzDrugliststruc The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_ID)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_ITEM_ID, $this->item_id);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_NUMBER)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_ITEM_NUMBER, $this->item_number);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_PEDIATRIC)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_IS_PEDIATRIC, $this->is_pediatric);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_ADULT)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_IS_ADULT, $this->is_adult);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_OTHER)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_IS_OTHER, $this->is_other);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_IS_CONSUMABLE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_IS_CONSUMABLE, $this->is_consumable);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_CODE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_CODE, $this->mems_item_code);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_DESCRIPTION)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_MEMS_ITEM_DESCRIPTION, $this->mems_item_description);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_PACK_SIZE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_MEMS_PACK_SIZE, $this->mems_pack_size);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_PRICE_PER_PACK_SIZE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_MEMS_PRICE_PER_PACK_SIZE, $this->mems_price_per_pack_size);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_MEMS_SIZES)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_MEMS_SIZES, $this->mems_sizes);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_DESCRIPTION)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_ITEM_DESCRIPTION, $this->item_description);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_ITEM_FULL_DESCRIPTION)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_ITEM_FULL_DESCRIPTION, $this->item_full_description);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_DOSAGE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_DOSAGE, $this->dosage);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_UNIT_PRICE)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_UNIT_PRICE, $this->unit_price);
        }
        if ($this->isColumnModified(CareTzDrugliststrucTableMap::COL_PURCHASING_CLASS)) {
            $criteria->add(CareTzDrugliststrucTableMap::COL_PURCHASING_CLASS, $this->purchasing_class);
        }
    ...
    {
        $criteria = ChildCareTzDrugliststrucQuery::create();
        $criteria->add(CareTzDrugliststrucTableMap::COL_ITEM_NUMBER, $this->item_number);
    ...
    {
        $validPk = null !== $this->getItemNumber();
    ...
    /**
     * Generic method to set the primary key (item_number column).
     *
    ...
    {
        return null === $this->getItemNumber();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzDrugliststruc (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzDrugliststruc Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTzDrugliststrucTableMap::DEFAULT_STRING_FORMAT);
    }
