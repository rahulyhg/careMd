...
use propel\propel\CareTzEyeHistory1 as ChildCareTzEyeHistory1;
...
abstract class CareTzEyeHistory1Query extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzEyeHistory1Query object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzEyeHistory1', $modelAlias = null)
    {
