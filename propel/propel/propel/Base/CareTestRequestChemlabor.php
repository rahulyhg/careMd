...
use propel\propel\CareTestRequestChemlaborQuery as ChildCareTestRequestChemlaborQuery;
use propel\propel\Map\CareTestRequestChemlaborTableMap;
...
abstract class CareTestRequestChemlabor implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTestRequestChemlaborTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTestRequestChemlabor object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTestRequestChemlabor The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTestRequestChemlabor'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTestRequestChemlabor
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTestRequestChemlabor The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTestRequestChemlabor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTestRequestChemlabor Clone of current object.
     * @throws PropelException
     */
