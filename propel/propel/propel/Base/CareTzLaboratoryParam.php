...
use propel\propel\CareTzLaboratoryParamQuery as ChildCareTzLaboratoryParamQuery;
use propel\propel\Map\CareTzLaboratoryParamTableMap;
...
abstract class CareTzLaboratoryParam implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzLaboratoryParamTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzLaboratoryParam object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTzLaboratoryParam The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzLaboratoryParam'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzLaboratoryParam
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzLaboratoryParam The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzLaboratoryParam (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzLaboratoryParam Clone of current object.
     * @throws PropelException
     */
