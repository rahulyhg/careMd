...
use propel\propel\CareTzCompanyQuery as ChildCareTzCompanyQuery;
use propel\propel\Map\CareTzCompanyTableMap;
...
abstract class CareTzCompany implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzCompanyTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzCompany object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTzCompany The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 16; // 16 = CareTzCompanyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzCompany'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzCompany
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzCompany The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzCompany (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzCompany Clone of current object.
     * @throws PropelException
     */
