...
use propel\propel\TblWhoIcd10 as ChildTblWhoIcd10;
...
abstract class TblWhoIcd10Query extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\TblWhoIcd10Query object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\TblWhoIcd10', $modelAlias = null)
    {
