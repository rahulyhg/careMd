...
use propel\propel\CareTechRepairDone as ChildCareTechRepairDone;
...
abstract class CareTechRepairDoneQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTechRepairDoneQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTechRepairDone', $modelAlias = null)
    {
