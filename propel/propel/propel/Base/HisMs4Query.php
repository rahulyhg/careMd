...
use propel\propel\HisMs4 as ChildHisMs4;
...
abstract class HisMs4Query extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\HisMs4Query object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\HisMs4', $modelAlias = null)
    {
