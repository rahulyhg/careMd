...
use propel\propel\CareTzIcd10Quicklist as ChildCareTzIcd10Quicklist;
...
abstract class CareTzIcd10QuicklistQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzIcd10QuicklistQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzIcd10Quicklist', $modelAlias = null)
    {
