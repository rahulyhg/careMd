...
use propel\propel\CarePharmaProductsMainQuery as ChildCarePharmaProductsMainQuery;
use propel\propel\Map\CarePharmaProductsMainTableMap;

/**
 * Base class that represents a row from the 'care_pharma_products_main' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CarePharmaProductsMain implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CarePharmaProductsMainTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CarePharmaProductsMain object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CarePharmaProductsMain</code> instance.  If
     * <code>obj</code> is an instance of <code>CarePharmaProductsMain</code>, delegates to
     * <code>equals(CarePharmaProductsMain)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CarePharmaProductsMain The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CarePharmaProductsMain The current object (for fluent API support)
     */
    public function setBestellnum($v)
    {
        ...
        if ($this->bestellnum !== $v) {
            $this->bestellnum = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_BESTELLNUM] = true;
        }
    ...
    public function setArtikelnum($v)
    {
        ...
        if ($this->artikelnum !== $v) {
            $this->artikelnum = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_ARTIKELNUM] = true;
        }
    ...
    public function setIndustrynum($v)
    {
        ...
        if ($this->industrynum !== $v) {
            $this->industrynum = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_INDUSTRYNUM] = true;
        }
    ...
    public function setArtikelname($v)
    {
        ...
        if ($this->artikelname !== $v) {
            $this->artikelname = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_ARTIKELNAME] = true;
        }
    ...
    public function setGeneric($v)
    {
        ...
        if ($this->generic !== $v) {
            $this->generic = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_GENERIC] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setPacking($v)
    {
        ...
        if ($this->packing !== $v) {
            $this->packing = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_PACKING] = true;
        }
    ...
    public function setMinorder($v)
    {
        ...
        if ($this->minorder !== $v) {
            $this->minorder = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_MINORDER] = true;
        }
    ...
    public function setMaxorder($v)
    {
        ...
        if ($this->maxorder !== $v) {
            $this->maxorder = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_MAXORDER] = true;
        }
    ...
    public function setProorder($v)
    {
        ...
        if ($this->proorder !== $v) {
            $this->proorder = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_PROORDER] = true;
        }
    ...
    public function setPicfile($v)
    {
        ...
        if ($this->picfile !== $v) {
            $this->picfile = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_PICFILE] = true;
        }
    ...
    public function setEncoder($v)
    {
        ...
        if ($this->encoder !== $v) {
            $this->encoder = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_ENCODER] = true;
        }
    ...
    public function setEncDate($v)
    {
        ...
        if ($this->enc_date !== $v) {
            $this->enc_date = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_ENC_DATE] = true;
        }
    ...
    public function setEncTime($v)
    {
        ...
        if ($this->enc_time !== $v) {
            $this->enc_time = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_ENC_TIME] = true;
        }
    ...
    public function setLockFlag($v)
    {
        ...
        if ($this->lock_flag !== $v) {
            $this->lock_flag = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_LOCK_FLAG] = true;
        }
    ...
    public function setMedgroup($v)
    {
        ...
        if ($this->medgroup !== $v) {
            $this->medgroup = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_MEDGROUP] = true;
        }
    ...
    public function setCave($v)
    {
        ...
        if ($this->cave !== $v) {
            $this->cave = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_CAVE] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_HISTORY] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_MODIFY_TIME] = true;
            }
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaProductsMainTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Bestellnum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bestellnum = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Artikelnum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artikelnum = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Industrynum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->industrynum = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Artikelname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artikelname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Generic', TableMap::TYPE_PHPNAME, $indexType)];
            $this->generic = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Packing', TableMap::TYPE_PHPNAME, $indexType)];
            $this->packing = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Minorder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minorder = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Maxorder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->maxorder = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Proorder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->proorder = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Picfile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->picfile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Encoder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->encoder = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('EncDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enc_date = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('EncTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enc_time = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('LockFlag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lock_flag = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Medgroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->medgroup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Cave', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cave = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : CarePharmaProductsMainTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 23; // 23 = CarePharmaProductsMainTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CarePharmaProductsMain'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCarePharmaProductsMainQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CarePharmaProductsMain::setDeleted()
     * @see CarePharmaProductsMain::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCarePharmaProductsMainQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CarePharmaProductsMainTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_BESTELLNUM)) {
            $modifiedColumns[':p' . $index++]  = 'bestellnum';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ARTIKELNUM)) {
            $modifiedColumns[':p' . $index++]  = 'artikelnum';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_INDUSTRYNUM)) {
            $modifiedColumns[':p' . $index++]  = 'industrynum';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ARTIKELNAME)) {
            $modifiedColumns[':p' . $index++]  = 'artikelname';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_GENERIC)) {
            $modifiedColumns[':p' . $index++]  = 'generic';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PACKING)) {
            $modifiedColumns[':p' . $index++]  = 'packing';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MINORDER)) {
            $modifiedColumns[':p' . $index++]  = 'minorder';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MAXORDER)) {
            $modifiedColumns[':p' . $index++]  = 'maxorder';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PROORDER)) {
            $modifiedColumns[':p' . $index++]  = 'proorder';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PICFILE)) {
            $modifiedColumns[':p' . $index++]  = 'picfile';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENCODER)) {
            $modifiedColumns[':p' . $index++]  = 'encoder';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENC_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'enc_date';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENC_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'enc_time';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_LOCK_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'lock_flag';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MEDGROUP)) {
            $modifiedColumns[':p' . $index++]  = 'medgroup';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CAVE)) {
            $modifiedColumns[':p' . $index++]  = 'cave';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }

        $sql = sprintf(
            'INSERT INTO care_pharma_products_main (%s) VALUES (%s)',
    ...
    {
        $pos = CarePharmaProductsMainTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CarePharmaProductsMain'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CarePharmaProductsMain'][$this->hashCode()] = true;
        $keys = CarePharmaProductsMainTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CarePharmaProductsMain
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CarePharmaProductsMain The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_BESTELLNUM)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_BESTELLNUM, $this->bestellnum);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ARTIKELNUM)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_ARTIKELNUM, $this->artikelnum);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_INDUSTRYNUM)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_INDUSTRYNUM, $this->industrynum);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ARTIKELNAME)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_ARTIKELNAME, $this->artikelname);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_GENERIC)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_GENERIC, $this->generic);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_DESCRIPTION)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PACKING)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_PACKING, $this->packing);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MINORDER)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_MINORDER, $this->minorder);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MAXORDER)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_MAXORDER, $this->maxorder);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PROORDER)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_PROORDER, $this->proorder);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_PICFILE)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_PICFILE, $this->picfile);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENCODER)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_ENCODER, $this->encoder);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENC_DATE)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_ENC_DATE, $this->enc_date);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_ENC_TIME)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_ENC_TIME, $this->enc_time);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_LOCK_FLAG)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_LOCK_FLAG, $this->lock_flag);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MEDGROUP)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_MEDGROUP, $this->medgroup);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CAVE)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_CAVE, $this->cave);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_STATUS)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_HISTORY)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MODIFY_ID)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CREATE_ID)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CarePharmaProductsMainTableMap::COL_CREATE_TIME)) {
            $criteria->add(CarePharmaProductsMainTableMap::COL_CREATE_TIME, $this->create_time);
        }
    ...
    {
        $criteria = ChildCarePharmaProductsMainQuery::create();
        $criteria->add(CarePharmaProductsMainTableMap::COL_BESTELLNUM, $this->bestellnum);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CarePharmaProductsMain (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CarePharmaProductsMain Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CarePharmaProductsMainTableMap::DEFAULT_STRING_FORMAT);
    }
