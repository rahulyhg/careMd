...
use propel\propel\CareTestRequestLaboratoryQuery as ChildCareTestRequestLaboratoryQuery;
use propel\propel\Map\CareTestRequestLaboratoryTableMap;

/**
 * Base class that represents a row from the 'care_test_request_laboratory' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTestRequestLaboratory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTestRequestLaboratoryTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTestRequestLaboratory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareTestRequestLaboratory</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTestRequestLaboratory</code>, delegates to
     * <code>equals(CareTestRequestLaboratory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTestRequestLaboratory The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTestRequestLaboratory The current object (for fluent API support)
     */
    public function setBatchNr($v)
    {
        ...
        if ($this->batch_nr !== $v) {
            $this->batch_nr = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_BATCH_NR] = true;
        }
    ...
    public function setEncounterNr($v)
    {
        ...
        if ($this->encounter_nr !== $v) {
            $this->encounter_nr = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_ENCOUNTER_NR] = true;
        }
    ...
    public function setRoomNr($v)
    {
        ...
        if ($this->room_nr !== $v) {
            $this->room_nr = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_ROOM_NR] = true;
        }
    ...
    public function setDeptNr($v)
    {
        ...
        if ($this->dept_nr !== $v) {
            $this->dept_nr = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_DEPT_NR] = true;
        }
    ...
    public function setDoctorSign($v)
    {
        ...
        if ($this->doctor_sign !== $v) {
            $this->doctor_sign = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_DOCTOR_SIGN] = true;
        }
    ...
    public function setHighrisk($v)
    {
        ...
        if ($this->highrisk !== $v) {
            $this->highrisk = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_HIGHRISK] = true;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_NOTES] = true;
        }
    ...
    public function setSendDate($v)
    {
        ...
        if ($this->send_date !== null || $dt !== null) {
            if ( ($dt != $this->send_date) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_SEND_DATE] = true;
            }
    ...
    public function setSampleTime($v)
    {
        ...
        if ($this->sample_time !== null || $dt !== null) {
            if ( ($dt != $this->sample_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_SAMPLE_TIME] = true;
            }
        } // if either are not null
    ...
    public function setSampleWeekday($v)
    {
        ...
        if ($this->sample_weekday !== $v) {
            ...
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_SAMPLE_WEEKDAY] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_HISTORY] = true;
        }
    ...
    public function setIsDisabled($v)
    {
        ...
        if ($this->is_disabled !== $v) {
            $this->is_disabled = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_IS_DISABLED] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_MODIFY_TIME] = true;
            }
        } // if either are not null
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestRequestLaboratoryTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('BatchNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->batch_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('EncounterNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->encounter_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('RoomNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->room_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('DeptNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('DoctorSign', TableMap::TYPE_PHPNAME, $indexType)];
            $this->doctor_sign = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('Highrisk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->highrisk = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('SendDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->send_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('SampleTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sample_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('SampleWeekday', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sample_weekday = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('IsDisabled', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_disabled = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CareTestRequestLaboratoryTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 17; // 17 = CareTestRequestLaboratoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTestRequestLaboratory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTestRequestLaboratoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTestRequestLaboratory::setDeleted()
     * @see CareTestRequestLaboratory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTestRequestLaboratoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTestRequestLaboratoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_BATCH_NR)) {
            $modifiedColumns[':p' . $index++]  = 'batch_nr';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_ENCOUNTER_NR)) {
            $modifiedColumns[':p' . $index++]  = 'encounter_nr';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_ROOM_NR)) {
            $modifiedColumns[':p' . $index++]  = 'room_nr';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_DEPT_NR)) {
            $modifiedColumns[':p' . $index++]  = 'dept_nr';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_DOCTOR_SIGN)) {
            $modifiedColumns[':p' . $index++]  = 'doctor_sign';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_HIGHRISK)) {
            $modifiedColumns[':p' . $index++]  = 'highrisk';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'notes';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SEND_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'send_date';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SAMPLE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'sample_time';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SAMPLE_WEEKDAY)) {
            $modifiedColumns[':p' . $index++]  = 'sample_weekday';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_IS_DISABLED)) {
            $modifiedColumns[':p' . $index++]  = 'is_disabled';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }

        $sql = sprintf(
            'INSERT INTO care_test_request_laboratory (%s) VALUES (%s)',
    ...
    {
        $pos = CareTestRequestLaboratoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTestRequestLaboratory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTestRequestLaboratory'][$this->hashCode()] = true;
        $keys = CareTestRequestLaboratoryTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBatchNr(),
            $keys[1] => $this->getEncounterNr(),
            $keys[2] => $this->getRoomNr(),
            $keys[3] => $this->getDeptNr(),
            $keys[4] => $this->getDoctorSign(),
            $keys[5] => $this->getHighrisk(),
            $keys[6] => $this->getNotes(),
            $keys[7] => $this->getSendDate(),
            $keys[8] => $this->getSampleTime(),
            $keys[9] => $this->getSampleWeekday(),
            $keys[10] => $this->getStatus(),
            $keys[11] => $this->getHistory(),
            $keys[12] => $this->getIsDisabled(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTestRequestLaboratory
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setDoctorSign($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setHighrisk($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setNotes($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setSendDate($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setSampleTime($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setSampleWeekday($arr[$keys[9]]);
        }
        ...
        if (array_key_exists($keys[12], $arr)) {
            $this->setIsDisabled($arr[$keys[12]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTestRequestLaboratory The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_BATCH_NR)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_BATCH_NR, $this->batch_nr);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_ENCOUNTER_NR)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_ENCOUNTER_NR, $this->encounter_nr);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_ROOM_NR)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_ROOM_NR, $this->room_nr);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_DEPT_NR)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_DEPT_NR, $this->dept_nr);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_DOCTOR_SIGN)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_DOCTOR_SIGN, $this->doctor_sign);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_HIGHRISK)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_HIGHRISK, $this->highrisk);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_NOTES)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_NOTES, $this->notes);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SEND_DATE)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_SEND_DATE, $this->send_date);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SAMPLE_TIME)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_SAMPLE_TIME, $this->sample_time);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_SAMPLE_WEEKDAY)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_SAMPLE_WEEKDAY, $this->sample_weekday);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_STATUS)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_HISTORY)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_IS_DISABLED)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_IS_DISABLED, $this->is_disabled);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_MODIFY_ID)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_CREATE_ID)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CareTestRequestLaboratoryTableMap::COL_CREATE_TIME)) {
            $criteria->add(CareTestRequestLaboratoryTableMap::COL_CREATE_TIME, $this->create_time);
        }
    ...
    {
        $criteria = ChildCareTestRequestLaboratoryQuery::create();
        $criteria->add(CareTestRequestLaboratoryTableMap::COL_BATCH_NR, $this->batch_nr);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTestRequestLaboratory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTestRequestLaboratory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTestRequestLaboratoryTableMap::DEFAULT_STRING_FORMAT);
    }
