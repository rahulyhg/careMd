...
use propel\propel\HisSwelabAlfaQuery as ChildHisSwelabAlfaQuery;
use propel\propel\Map\HisSwelabAlfaTableMap;
...
abstract class HisSwelabAlfa implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\HisSwelabAlfaTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\HisSwelabAlfa object.
     */
     ...
     * @return $this|\propel\propel\HisSwelabAlfa The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\HisSwelabAlfa'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\HisSwelabAlfa
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\HisSwelabAlfa The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\HisSwelabAlfa (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\HisSwelabAlfa Clone of current object.
     * @throws PropelException
     */
