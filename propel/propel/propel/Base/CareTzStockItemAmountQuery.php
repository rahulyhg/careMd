...
use propel\propel\CareTzStockItemAmount as ChildCareTzStockItemAmount;
...
abstract class CareTzStockItemAmountQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzStockItemAmountQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzStockItemAmount', $modelAlias = null)
    {
