...
use propel\propel\CareTzArvCoMedi as ChildCareTzArvCoMedi;
...
abstract class CareTzArvCoMediQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzArvCoMediQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzArvCoMedi', $modelAlias = null)
    {
