...
use propel\propel\CareTzEyeHistory2 as ChildCareTzEyeHistory2;
...
abstract class CareTzEyeHistory2Query extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzEyeHistory2Query object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzEyeHistory2', $modelAlias = null)
    {
