...
use propel\propel\CareTestFindingsRadioQuery as ChildCareTestFindingsRadioQuery;
use propel\propel\Map\CareTestFindingsRadioTableMap;

/**
 * Base class that represents a row from the 'care_test_findings_radio' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTestFindingsRadio implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTestFindingsRadioTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTestFindingsRadio object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareTestFindingsRadio</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTestFindingsRadio</code>, delegates to
     * <code>equals(CareTestFindingsRadio)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTestFindingsRadio The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTestFindingsRadio The current object (for fluent API support)
     */
    public function setBatchNr($v)
    {
        ...
        if ($this->batch_nr !== $v) {
            $this->batch_nr = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_BATCH_NR] = true;
        }
    ...
    public function setEncounterNr($v)
    {
        ...
        if ($this->encounter_nr !== $v) {
            $this->encounter_nr = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_ENCOUNTER_NR] = true;
        }
    ...
    public function setRoomNr($v)
    {
        ...
        if ($this->room_nr !== $v) {
            $this->room_nr = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_ROOM_NR] = true;
        }
    ...
    public function setDeptNr($v)
    {
        ...
        if ($this->dept_nr !== $v) {
            $this->dept_nr = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_DEPT_NR] = true;
        }
    ...
    public function setFindings($v)
    {
        ...
        if ($this->findings !== $v) {
            $this->findings = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_FINDINGS] = true;
        }
    ...
    public function setDiagnosis($v)
    {
        ...
        if ($this->diagnosis !== $v) {
            $this->diagnosis = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_DIAGNOSIS] = true;
        }
    ...
    public function setDoctorId($v)
    {
        ...
        if ($this->doctor_id !== $v) {
            $this->doctor_id = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_DOCTOR_ID] = true;
        }
    ...
    public function setFindingsDate($v)
    {
        ...
        if ($this->findings_date !== null || $dt !== null) {
            if ( ($dt != $this->findings_date) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_FINDINGS_DATE] = true;
            }
    ...
    public function setFindingsTime($v)
    {
        ...
        if ($this->findings_time !== null || $dt !== null) {
            if ( ($dt != $this->findings_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_FINDINGS_TIME] = true;
            }
        } // if either are not null
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_HISTORY] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_MODIFY_TIME] = true;
            }
        } // if either are not null
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsRadioTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('BatchNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->batch_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('EncounterNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->encounter_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('RoomNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->room_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('DeptNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('Findings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->findings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('Diagnosis', TableMap::TYPE_PHPNAME, $indexType)];
            $this->diagnosis = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('DoctorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->doctor_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('FindingsDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->findings_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('FindingsTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->findings_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTestFindingsRadioTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 15; // 15 = CareTestFindingsRadioTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTestFindingsRadio'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTestFindingsRadioQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTestFindingsRadio::setDeleted()
     * @see CareTestFindingsRadio::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTestFindingsRadioQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTestFindingsRadioTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_BATCH_NR)) {
            $modifiedColumns[':p' . $index++]  = 'batch_nr';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_ENCOUNTER_NR)) {
            $modifiedColumns[':p' . $index++]  = 'encounter_nr';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_ROOM_NR)) {
            $modifiedColumns[':p' . $index++]  = 'room_nr';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DEPT_NR)) {
            $modifiedColumns[':p' . $index++]  = 'dept_nr';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS)) {
            $modifiedColumns[':p' . $index++]  = 'findings';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DIAGNOSIS)) {
            $modifiedColumns[':p' . $index++]  = 'diagnosis';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DOCTOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'doctor_id';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'findings_date';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'findings_time';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }

        $sql = sprintf(
            'INSERT INTO care_test_findings_radio (%s) VALUES (%s)',
    ...
    {
        $pos = CareTestFindingsRadioTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTestFindingsRadio'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTestFindingsRadio'][$this->hashCode()] = true;
        $keys = CareTestFindingsRadioTableMap::getFieldNames($keyType);
        $result = array(
            ...
            $keys[6] => $this->getDoctorId(),
            $keys[7] => $this->getFindingsDate(),
            $keys[8] => $this->getFindingsTime(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTestFindingsRadio
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setFindings($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDiagnosis($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setDoctorId($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setFindingsDate($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setFindingsTime($arr[$keys[8]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTestFindingsRadio The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_BATCH_NR)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_BATCH_NR, $this->batch_nr);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_ENCOUNTER_NR)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_ENCOUNTER_NR, $this->encounter_nr);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_ROOM_NR)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_ROOM_NR, $this->room_nr);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DEPT_NR)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_DEPT_NR, $this->dept_nr);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_FINDINGS, $this->findings);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DIAGNOSIS)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_DIAGNOSIS, $this->diagnosis);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_DOCTOR_ID)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_DOCTOR_ID, $this->doctor_id);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS_DATE)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_FINDINGS_DATE, $this->findings_date);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_FINDINGS_TIME)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_FINDINGS_TIME, $this->findings_time);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_STATUS)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_HISTORY)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_MODIFY_ID)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_CREATE_ID)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CareTestFindingsRadioTableMap::COL_CREATE_TIME)) {
            $criteria->add(CareTestFindingsRadioTableMap::COL_CREATE_TIME, $this->create_time);
        }
    ...
    {
        $criteria = ChildCareTestFindingsRadioQuery::create();
        $criteria->add(CareTestFindingsRadioTableMap::COL_BATCH_NR, $this->batch_nr);
        $criteria->add(CareTestFindingsRadioTableMap::COL_ENCOUNTER_NR, $this->encounter_nr);
    ...
    {
        return (null === $this->getBatchNr()) && (null === $this->getEncounterNr());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTestFindingsRadio (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTestFindingsRadio Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTestFindingsRadioTableMap::DEFAULT_STRING_FORMAT);
    }
