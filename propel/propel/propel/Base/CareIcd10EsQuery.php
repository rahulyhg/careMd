...
use propel\propel\CareIcd10Es as ChildCareIcd10Es;
...
abstract class CareIcd10EsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareIcd10EsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareIcd10Es', $modelAlias = null)
    {
