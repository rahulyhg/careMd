...
use propel\propel\CarePhoneQuery as ChildCarePhoneQuery;
use propel\propel\Map\CarePhoneTableMap;
...
abstract class CarePhone implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CarePhoneTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CarePhone object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CarePhone The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CarePhone'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CarePhone
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CarePhone The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CarePhone (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CarePhone Clone of current object.
     * @throws PropelException
     */
