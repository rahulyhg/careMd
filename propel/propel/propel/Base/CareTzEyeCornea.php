...
use propel\propel\CareTzEyeCorneaQuery as ChildCareTzEyeCorneaQuery;
use propel\propel\Map\CareTzEyeCorneaTableMap;

/**
 * Base class that represents a row from the 'care_tz_eye_cornea' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTzEyeCornea implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzEyeCorneaTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzEyeCornea object.
     */
    ...
    /**
     * Compares this with another <code>CareTzEyeCornea</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTzEyeCornea</code>, delegates to
     * <code>equals(CareTzEyeCornea)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTzEyeCornea The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTzEyeCornea The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_ID] = true;
        }
    ...
    public function setPid($v)
    {
        ...
        if ($this->pid !== $v) {
            $this->pid = $v;
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_PID] = true;
        }
    ...
    public function setRightEyeTest1($v)
    {
        ...
        if ($this->right_eye_test1 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST1] = true;
        }
    ...
    public function setRightEyeTest2($v)
    {
        ...
        if ($this->right_eye_test2 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST2] = true;
        }
    ...
    public function setRightEyeTest3($v)
    {
        ...
        if ($this->right_eye_test3 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST3] = true;
        }
    ...
    public function setRightEyeTest4($v)
    {
        ...
        if ($this->right_eye_test4 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST4] = true;
        }
    ...
    public function setRightEyeTest5($v)
    {
        ...
        if ($this->right_eye_test5 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST5] = true;
        }
    ...
    public function setRightEyeTest6($v)
    {
        ...
        if ($this->right_eye_test6 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST6] = true;
        }
    ...
    public function setRightEyeTest7($v)
    {
        ...
        if ($this->right_eye_test7 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST7] = true;
        }
    ...
    public function setLeftEyeTest1($v)
    {
        ...
        if ($this->left_eye_test1 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST1] = true;
        }
    ...
    public function setLeftEyeTest2($v)
    {
        ...
        if ($this->left_eye_test2 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST2] = true;
        }
    ...
    public function setLeftEyeTest3($v)
    {
        ...
        if ($this->left_eye_test3 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST3] = true;
        }
    ...
    public function setLeftEyeTest4($v)
    {
        ...
        if ($this->left_eye_test4 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST4] = true;
        }
    ...
    public function setLeftEyeTest5($v)
    {
        ...
        if ($this->left_eye_test5 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST5] = true;
        }
    ...
    public function setLeftEyeTest6($v)
    {
        ...
        if ($this->left_eye_test6 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST6] = true;
        }
    ...
    public function setLeftEyeTest7($v)
    {
        ...
        if ($this->left_eye_test7 !== $v) {
            ...
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST7] = true;
        }
    ...
    public function setSignature($v)
    {
        ...
        if ($this->signature !== $v) {
            $this->signature = $v;
            $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_SIGNATURE] = true;
        }
    ...
    public function setExaminationDate($v)
    {
        ...
        if ($this->examination_date !== null || $dt !== null) {
            if ($this->examination_date === null || $dt === null || $dt->format("Y-m-d") !== $this->examination_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[CareTzEyeCorneaTableMap::COL_EXAMINATION_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('Pid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('RightEyeTest7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->right_eye_test7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('LeftEyeTest7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->left_eye_test7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('Signature', TableMap::TYPE_PHPNAME, $indexType)];
            $this->signature = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CareTzEyeCorneaTableMap::translateFieldName('ExaminationDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 18; // 18 = CareTzEyeCorneaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzEyeCornea'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTzEyeCorneaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTzEyeCornea::setDeleted()
     * @see CareTzEyeCornea::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTzEyeCorneaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTzEyeCorneaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_PID)) {
            $modifiedColumns[':p' . $index++]  = 'pid';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST1)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test1';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST2)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test2';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST3)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test3';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST4)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test4';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST5)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test5';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST6)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test6';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST7)) {
            $modifiedColumns[':p' . $index++]  = 'right_eye_test7';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST1)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test1';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST2)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test2';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST3)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test3';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST4)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test4';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST5)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test5';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST6)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test6';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST7)) {
            $modifiedColumns[':p' . $index++]  = 'left_eye_test7';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = 'Signature';
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_EXAMINATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'Examination_date';
        }

        $sql = sprintf(
            'INSERT INTO care_tz_eye_cornea (%s) VALUES (%s)',
    ...
    {
        $pos = CareTzEyeCorneaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTzEyeCornea'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTzEyeCornea'][$this->hashCode()] = true;
        $keys = CareTzEyeCorneaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzEyeCornea
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzEyeCornea The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_ID)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_PID)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_PID, $this->pid);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST1)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST1, $this->right_eye_test1);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST2)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST2, $this->right_eye_test2);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST3)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST3, $this->right_eye_test3);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST4)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST4, $this->right_eye_test4);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST5)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST5, $this->right_eye_test5);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST6)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST6, $this->right_eye_test6);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST7)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_RIGHT_EYE_TEST7, $this->right_eye_test7);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST1)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST1, $this->left_eye_test1);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST2)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST2, $this->left_eye_test2);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST3)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST3, $this->left_eye_test3);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST4)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST4, $this->left_eye_test4);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST5)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST5, $this->left_eye_test5);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST6)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST6, $this->left_eye_test6);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST7)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_LEFT_EYE_TEST7, $this->left_eye_test7);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_SIGNATURE)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_SIGNATURE, $this->signature);
        }
        if ($this->isColumnModified(CareTzEyeCorneaTableMap::COL_EXAMINATION_DATE)) {
            $criteria->add(CareTzEyeCorneaTableMap::COL_EXAMINATION_DATE, $this->examination_date);
        }
    ...
    {
        $criteria = ChildCareTzEyeCorneaQuery::create();
        $criteria->add(CareTzEyeCorneaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzEyeCornea (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzEyeCornea Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTzEyeCorneaTableMap::DEFAULT_STRING_FORMAT);
    }
