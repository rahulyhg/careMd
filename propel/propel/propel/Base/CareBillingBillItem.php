...
use propel\propel\CareBillingBillItemQuery as ChildCareBillingBillItemQuery;
use propel\propel\Map\CareBillingBillItemTableMap;
...
abstract class CareBillingBillItem implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareBillingBillItemTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareBillingBillItem object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareBillingBillItem The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareBillingBillItem'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareBillingBillItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareBillingBillItem The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareBillingBillItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareBillingBillItem Clone of current object.
     * @throws PropelException
     */
