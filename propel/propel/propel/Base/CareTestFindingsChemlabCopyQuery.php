...
use propel\propel\CareTestFindingsChemlabCopy as ChildCareTestFindingsChemlabCopy;
...
abstract class CareTestFindingsChemlabCopyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTestFindingsChemlabCopyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTestFindingsChemlabCopy', $modelAlias = null)
    {
