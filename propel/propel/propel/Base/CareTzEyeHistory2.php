...
use propel\propel\CareTzEyeHistory2Query as ChildCareTzEyeHistory2Query;
use propel\propel\Map\CareTzEyeHistory2TableMap;
...
abstract class CareTzEyeHistory2 implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTzEyeHistory2TableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTzEyeHistory2 object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareTzEyeHistory2 The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTzEyeHistory2'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTzEyeHistory2
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTzEyeHistory2 The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTzEyeHistory2 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTzEyeHistory2 Clone of current object.
     * @throws PropelException
     */
