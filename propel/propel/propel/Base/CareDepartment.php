...
use propel\propel\CareDepartmentQuery as ChildCareDepartmentQuery;
use propel\propel\Map\CareDepartmentTableMap;
...
abstract class CareDepartment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareDepartmentTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareDepartment object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareDepartment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareDepartment'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareDepartment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareDepartment The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareDepartment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareDepartment Clone of current object.
     * @throws PropelException
     */
