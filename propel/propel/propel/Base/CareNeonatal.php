...
use propel\propel\CareNeonatalQuery as ChildCareNeonatalQuery;
use propel\propel\Map\CareNeonatalTableMap;
...
abstract class CareNeonatal implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareNeonatalTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareNeonatal object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareNeonatal The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareNeonatal'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareNeonatal
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareNeonatal The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareNeonatal (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareNeonatal Clone of current object.
     * @throws PropelException
     */
