...
use propel\propel\CareAddressCitytown as ChildCareAddressCitytown;
...
abstract class CareAddressCitytownQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareAddressCitytownQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareAddressCitytown', $modelAlias = null)
    {
