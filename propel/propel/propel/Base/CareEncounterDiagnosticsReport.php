...
use propel\propel\CareEncounterDiagnosticsReportQuery as ChildCareEncounterDiagnosticsReportQuery;
use propel\propel\Map\CareEncounterDiagnosticsReportTableMap;
...
abstract class CareEncounterDiagnosticsReport implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareEncounterDiagnosticsReportTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareEncounterDiagnosticsReport object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareEncounterDiagnosticsReport The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareEncounterDiagnosticsReport'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareEncounterDiagnosticsReport
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareEncounterDiagnosticsReport The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareEncounterDiagnosticsReport (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareEncounterDiagnosticsReport Clone of current object.
     * @throws PropelException
     */
