...
use propel\propel\CareEncounterImmunizationQuery as ChildCareEncounterImmunizationQuery;
use propel\propel\Map\CareEncounterImmunizationTableMap;
...
abstract class CareEncounterImmunization implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareEncounterImmunizationTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareEncounterImmunization object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareEncounterImmunization The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareEncounterImmunization'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareEncounterImmunization
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareEncounterImmunization The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareEncounterImmunization (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareEncounterImmunization Clone of current object.
     * @throws PropelException
     */
