...
use propel\propel\CareTestFindingsChemlabQuery as ChildCareTestFindingsChemlabQuery;
use propel\propel\Map\CareTestFindingsChemlabTableMap;

/**
 * Base class that represents a row from the 'care_test_findings_chemlab' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CareTestFindingsChemlab implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareTestFindingsChemlabTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareTestFindingsChemlab object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CareTestFindingsChemlab</code> instance.  If
     * <code>obj</code> is an instance of <code>CareTestFindingsChemlab</code>, delegates to
     * <code>equals(CareTestFindingsChemlab)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CareTestFindingsChemlab The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CareTestFindingsChemlab The current object (for fluent API support)
     */
    public function setBatchNr($v)
    {
        ...
        if ($this->batch_nr !== $v) {
            $this->batch_nr = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_BATCH_NR] = true;
        }
    ...
    public function setEncounterNr($v)
    {
        ...
        if ($this->encounter_nr !== $v) {
            $this->encounter_nr = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_ENCOUNTER_NR] = true;
        }
    ...
    public function setJobId($v)
    {
        ...
        if ($this->job_id !== $v) {
            $this->job_id = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_JOB_ID] = true;
        }
    ...
    public function setTestDate($v)
    {
        ...
        if ($this->test_date !== null || $dt !== null) {
            if ( ($dt != $this->test_date) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_TEST_DATE] = true;
            }
    ...
    public function setTestTime($v)
    {
        ...
        if ($this->test_time !== null || $dt !== null) {
            if ( ($dt != $this->test_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_TEST_TIME] = true;
            }
        } // if either are not null
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function setSerialValue($v)
    {
        ...
        if ($this->serial_value !== $v) {
            $this->serial_value = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_SERIAL_VALUE] = true;
        }
    ...
    public function setAddValue($v)
    {
        ...
        if ($this->add_value !== $v) {
            $this->add_value = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_ADD_VALUE] = true;
        }
    ...
    public function setValidator($v)
    {
        ...
        if ($this->validator !== $v) {
            $this->validator = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_VALIDATOR] = true;
        }
    ...
    public function setValidateDt($v)
    {
        ...
        if ($this->validate_dt !== null || $dt !== null) {
            if ( ($dt != $this->validate_dt) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_VALIDATE_DT] = true;
            }
        } // if either are not null
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_HISTORY] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_MODIFY_TIME] = true;
            }
        } // if either are not null
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CareTestFindingsChemlabTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('BatchNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->batch_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('EncounterNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->encounter_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('JobId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->job_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('TestDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->test_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('TestTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->test_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('SerialValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serial_value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('AddValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->add_value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('Validator', TableMap::TYPE_PHPNAME, $indexType)];
            $this->validator = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('ValidateDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->validate_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CareTestFindingsChemlabTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 16; // 16 = CareTestFindingsChemlabTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareTestFindingsChemlab'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCareTestFindingsChemlabQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CareTestFindingsChemlab::setDeleted()
     * @see CareTestFindingsChemlab::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCareTestFindingsChemlabQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CareTestFindingsChemlabTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->batch_nr) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CareTestFindingsChemlabTableMap::COL_BATCH_NR . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_BATCH_NR)) {
            $modifiedColumns[':p' . $index++]  = 'batch_nr';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_ENCOUNTER_NR)) {
            $modifiedColumns[':p' . $index++]  = 'encounter_nr';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_JOB_ID)) {
            $modifiedColumns[':p' . $index++]  = 'job_id';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_TEST_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'test_date';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_TEST_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'test_time';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'group_id';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_SERIAL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'serial_value';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_ADD_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'add_value';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_VALIDATOR)) {
            $modifiedColumns[':p' . $index++]  = 'validator';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_VALIDATE_DT)) {
            $modifiedColumns[':p' . $index++]  = 'validate_dt';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }

        $sql = sprintf(
            'INSERT INTO care_test_findings_chemlab (%s) VALUES (%s)',
    ...
    {
        $pos = CareTestFindingsChemlabTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CareTestFindingsChemlab'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CareTestFindingsChemlab'][$this->hashCode()] = true;
        $keys = CareTestFindingsChemlabTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareTestFindingsChemlab
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareTestFindingsChemlab The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(CareTestFindingsChemlabTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_BATCH_NR)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_BATCH_NR, $this->batch_nr);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_ENCOUNTER_NR)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_ENCOUNTER_NR, $this->encounter_nr);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_JOB_ID)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_JOB_ID, $this->job_id);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_TEST_DATE)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_TEST_DATE, $this->test_date);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_TEST_TIME)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_TEST_TIME, $this->test_time);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_GROUP_ID)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_SERIAL_VALUE)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_SERIAL_VALUE, $this->serial_value);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_ADD_VALUE)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_ADD_VALUE, $this->add_value);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_VALIDATOR)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_VALIDATOR, $this->validator);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_VALIDATE_DT)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_VALIDATE_DT, $this->validate_dt);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_STATUS)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_HISTORY)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_MODIFY_ID)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_CREATE_ID)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CareTestFindingsChemlabTableMap::COL_CREATE_TIME)) {
            $criteria->add(CareTestFindingsChemlabTableMap::COL_CREATE_TIME, $this->create_time);
        }
    ...
    {
        $criteria = ChildCareTestFindingsChemlabQuery::create();
        $criteria->add(CareTestFindingsChemlabTableMap::COL_BATCH_NR, $this->batch_nr);
        $criteria->add(CareTestFindingsChemlabTableMap::COL_ENCOUNTER_NR, $this->encounter_nr);
        $criteria->add(CareTestFindingsChemlabTableMap::COL_JOB_ID, $this->job_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareTestFindingsChemlab (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareTestFindingsChemlab Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CareTestFindingsChemlabTableMap::DEFAULT_STRING_FORMAT);
    }
