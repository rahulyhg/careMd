...
use propel\propel\CareTzEyePosteriorSegment as ChildCareTzEyePosteriorSegment;
...
abstract class CareTzEyePosteriorSegmentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel\propel\Base\CareTzEyePosteriorSegmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel\\propel\\CareTzEyePosteriorSegment', $modelAlias = null)
    {
