...
use propel\propel\CareMedOrderlistQuery as ChildCareMedOrderlistQuery;
use propel\propel\Map\CareMedOrderlistTableMap;
...
abstract class CareMedOrderlist implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CareMedOrderlistTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CareMedOrderlist object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\propel\propel\CareMedOrderlist The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CareMedOrderlist'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CareMedOrderlist
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CareMedOrderlist The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CareMedOrderlist (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CareMedOrderlist Clone of current object.
     * @throws PropelException
     */
