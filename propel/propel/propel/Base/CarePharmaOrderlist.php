...
use propel\propel\CarePharmaOrderlistQuery as ChildCarePharmaOrderlistQuery;
use propel\propel\Map\CarePharmaOrderlistTableMap;

/**
 * Base class that represents a row from the 'care_pharma_orderlist' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class CarePharmaOrderlist implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\CarePharmaOrderlistTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\CarePharmaOrderlist object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CarePharmaOrderlist</code> instance.  If
     * <code>obj</code> is an instance of <code>CarePharmaOrderlist</code>, delegates to
     * <code>equals(CarePharmaOrderlist)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CarePharmaOrderlist The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\CarePharmaOrderlist The current object (for fluent API support)
     */
    public function setOrderNr($v)
    {
        ...
        if ($this->order_nr !== $v) {
            $this->order_nr = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_ORDER_NR] = true;
        }
    ...
    public function setDeptNr($v)
    {
        ...
        if ($this->dept_nr !== $v) {
            $this->dept_nr = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_DEPT_NR] = true;
        }
    ...
    public function setOrderDate($v)
    {
        ...
        if ($this->order_date !== null || $dt !== null) {
            if ( ($dt != $this->order_date) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_ORDER_DATE] = true;
            }
    ...
    public function setOrderTime($v)
    {
        ...
        if ($this->order_time !== null || $dt !== null) {
            if ( ($dt != $this->order_time) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_ORDER_TIME] = true;
            }
        } // if either are not null
    ...
    public function setArticles($v)
    {
        ...
        if ($this->articles !== $v) {
            $this->articles = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_ARTICLES] = true;
        }
    ...
    public function setExtra1($v)
    {
        ...
        if ($this->extra1 !== $v) {
            $this->extra1 = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_EXTRA1] = true;
        }
    ...
    public function setExtra2($v)
    {
        ...
        if ($this->extra2 !== $v) {
            $this->extra2 = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_EXTRA2] = true;
        }
    ...
    public function setValidator($v)
    {
        ...
        if ($this->validator !== $v) {
            $this->validator = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_VALIDATOR] = true;
        }
    ...
    public function setIpAddr($v)
    {
        ...
        if ($this->ip_addr !== $v) {
            $this->ip_addr = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_IP_ADDR] = true;
        }
    ...
    public function setPriority($v)
    {
        ...
        if ($this->priority !== $v) {
            $this->priority = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_PRIORITY] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_STATUS] = true;
        }
    ...
    public function setHistory($v)
    {
        ...
        if ($this->history !== $v) {
            $this->history = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_HISTORY] = true;
        }
    ...
    public function setModifyId($v)
    {
        ...
        if ($this->modify_id !== $v) {
            $this->modify_id = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_MODIFY_ID] = true;
        }
    ...
    public function setModifyTime($v)
    {
        ...
        if ($this->modify_time !== null || $dt !== null) {
            if ($this->modify_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modify_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_MODIFY_TIME] = true;
            }
        } // if either are not null
    ...
    public function setCreateId($v)
    {
        ...
        if ($this->create_id !== $v) {
            $this->create_id = $v;
            $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_CREATE_ID] = true;
        }
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ( ($dt != $this->create_time) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_CREATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function setSentDatetime($v)
    {
        ...
        if ($this->sent_datetime !== null || $dt !== null) {
            if ( ($dt != $this->sent_datetime) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_SENT_DATETIME] = true;
            }
        } // if either are not null
    ...
    public function setProcessDatetime($v)
    {
        ...
        if ($this->process_datetime !== null || $dt !== null) {
            if ( ($dt != $this->process_datetime) // normalized values don't match
                ...
                $this->modifiedColumns[CarePharmaOrderlistTableMap::COL_PROCESS_DATETIME] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('OrderNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('DeptNr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept_nr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('OrderDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->order_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('OrderTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Articles', TableMap::TYPE_PHPNAME, $indexType)];
            $this->articles = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Extra1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extra1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Extra2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extra2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Validator', TableMap::TYPE_PHPNAME, $indexType)];
            $this->validator = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('IpAddr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ip_addr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Priority', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priority = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('History', TableMap::TYPE_PHPNAME, $indexType)];
            $this->history = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('ModifyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modify_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('ModifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modify_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('CreateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->create_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->create_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('SentDatetime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->sent_datetime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CarePharmaOrderlistTableMap::translateFieldName('ProcessDatetime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 18; // 18 = CarePharmaOrderlistTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\CarePharmaOrderlist'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCarePharmaOrderlistQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CarePharmaOrderlist::setDeleted()
     * @see CarePharmaOrderlist::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCarePharmaOrderlistQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CarePharmaOrderlistTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_NR)) {
            $modifiedColumns[':p' . $index++]  = 'order_nr';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_DEPT_NR)) {
            $modifiedColumns[':p' . $index++]  = 'dept_nr';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'order_date';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'order_time';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ARTICLES)) {
            $modifiedColumns[':p' . $index++]  = 'articles';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_EXTRA1)) {
            $modifiedColumns[':p' . $index++]  = 'extra1';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_EXTRA2)) {
            $modifiedColumns[':p' . $index++]  = 'extra2';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_VALIDATOR)) {
            $modifiedColumns[':p' . $index++]  = 'validator';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_IP_ADDR)) {
            $modifiedColumns[':p' . $index++]  = 'ip_addr';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_PRIORITY)) {
            $modifiedColumns[':p' . $index++]  = 'priority';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_HISTORY)) {
            $modifiedColumns[':p' . $index++]  = 'history';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_MODIFY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'modify_id';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_MODIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'modify_time';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_CREATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'create_id';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_CREATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'create_time';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_SENT_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = 'sent_datetime';
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_PROCESS_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = 'process_datetime';
        }

        $sql = sprintf(
            'INSERT INTO care_pharma_orderlist (%s) VALUES (%s)',
    ...
    {
        $pos = CarePharmaOrderlistTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CarePharmaOrderlist'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CarePharmaOrderlist'][$this->hashCode()] = true;
        $keys = CarePharmaOrderlistTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\CarePharmaOrderlist
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\CarePharmaOrderlist The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_NR)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_ORDER_NR, $this->order_nr);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_DEPT_NR)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_DEPT_NR, $this->dept_nr);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_DATE)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_ORDER_DATE, $this->order_date);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ORDER_TIME)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_ORDER_TIME, $this->order_time);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_ARTICLES)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_ARTICLES, $this->articles);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_EXTRA1)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_EXTRA1, $this->extra1);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_EXTRA2)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_EXTRA2, $this->extra2);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_VALIDATOR)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_VALIDATOR, $this->validator);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_IP_ADDR)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_IP_ADDR, $this->ip_addr);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_PRIORITY)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_PRIORITY, $this->priority);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_STATUS)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_HISTORY)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_HISTORY, $this->history);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_MODIFY_ID)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_MODIFY_ID, $this->modify_id);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_MODIFY_TIME)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_MODIFY_TIME, $this->modify_time);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_CREATE_ID)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_CREATE_ID, $this->create_id);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_CREATE_TIME)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_CREATE_TIME, $this->create_time);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_SENT_DATETIME)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_SENT_DATETIME, $this->sent_datetime);
        }
        if ($this->isColumnModified(CarePharmaOrderlistTableMap::COL_PROCESS_DATETIME)) {
            $criteria->add(CarePharmaOrderlistTableMap::COL_PROCESS_DATETIME, $this->process_datetime);
        }
    ...
    {
        $criteria = ChildCarePharmaOrderlistQuery::create();
        $criteria->add(CarePharmaOrderlistTableMap::COL_ORDER_NR, $this->order_nr);
        $criteria->add(CarePharmaOrderlistTableMap::COL_DEPT_NR, $this->dept_nr);
    ...
    {
        return (null === $this->getOrderNr()) && (null === $this->getDeptNr());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\CarePharmaOrderlist (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\CarePharmaOrderlist Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CarePharmaOrderlistTableMap::DEFAULT_STRING_FORMAT);
    }
