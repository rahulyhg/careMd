...
use propel\propel\CarePharmaProductsMain;
use propel\propel\CarePharmaProductsMainQuery;
...
class CarePharmaProductsMainTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePharmaProductsMainTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePharmaProductsMain';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePharmaProductsMain';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePharmaProductsMain');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePharmaProductsMain) { // it's a model object
