...
use propel\propel\CareTzDistrict;
use propel\propel\CareTzDistrictQuery;
...
class CareTzDistrictTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDistrictTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDistrict';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDistrict';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDistrict');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDistrict) { // it's a model object
