...
use propel\propel\CareAppointment;
use propel\propel\CareAppointmentQuery;
...
class CareAppointmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareAppointmentTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareAppointment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareAppointment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareAppointment');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareAppointment) { // it's a model object
