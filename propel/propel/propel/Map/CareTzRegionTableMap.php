...
use propel\propel\CareTzRegion;
use propel\propel\CareTzRegionQuery;
...
class CareTzRegionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzRegionTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzRegion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzRegion';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzRegion');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzRegion) { // it's a model object
