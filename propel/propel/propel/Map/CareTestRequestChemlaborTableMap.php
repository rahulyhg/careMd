...
use propel\propel\CareTestRequestChemlabor;
use propel\propel\CareTestRequestChemlaborQuery;
...
class CareTestRequestChemlaborTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestChemlaborTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestChemlabor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestChemlabor';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestChemlabor');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestChemlabor) { // it's a model object
