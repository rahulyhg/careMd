...
use propel\propel\CareTzDhisElement;
use propel\propel\CareTzDhisElementQuery;
...
class CareTzDhisElementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDhisElementTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDhisElement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDhisElement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDhisElement');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDhisElement) { // it's a model object
