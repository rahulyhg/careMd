...
use propel\propel\TblWhoIcd10;
use propel\propel\TblWhoIcd10Query;
...
class TblWhoIcd10TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.TblWhoIcd10TableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\TblWhoIcd10';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.TblWhoIcd10';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\TblWhoIcd10');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\TblWhoIcd10) { // it's a model object
