...
use propel\propel\CareEncounterMeasurement;
use propel\propel\CareEncounterMeasurementQuery;
...
class CareEncounterMeasurementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterMeasurementTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterMeasurement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterMeasurement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterMeasurement');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterMeasurement) { // it's a model object
