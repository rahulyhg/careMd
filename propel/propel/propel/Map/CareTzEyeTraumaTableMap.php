...
use propel\propel\CareTzEyeTrauma;
use propel\propel\CareTzEyeTraumaQuery;
...
class CareTzEyeTraumaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeTraumaTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeTrauma';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeTrauma';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeTrauma');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeTrauma) { // it's a model object
