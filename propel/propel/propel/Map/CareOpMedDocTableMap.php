...
use propel\propel\CareOpMedDoc;
use propel\propel\CareOpMedDocQuery;
...
class CareOpMedDocTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareOpMedDocTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareOpMedDoc';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareOpMedDoc';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareOpMedDoc');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareOpMedDoc) { // it's a model object
