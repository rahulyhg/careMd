...
use propel\propel\CarePersonInsurance;
use propel\propel\CarePersonInsuranceQuery;
...
class CarePersonInsuranceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePersonInsuranceTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePersonInsurance';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePersonInsurance';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePersonInsurance');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePersonInsurance) { // it's a model object
