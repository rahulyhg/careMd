...
use propel\propel\CareUsers;
use propel\propel\CareUsersQuery;
...
class CareUsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareUsersTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareUsers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareUsers';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareUsers');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareUsers) { // it's a model object
