...
use propel\propel\CareTzArvCase;
use propel\propel\CareTzArvCaseQuery;
...
class CareTzArvCaseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvCaseTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvCase';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvCase';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvCase');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvCase) { // it's a model object
