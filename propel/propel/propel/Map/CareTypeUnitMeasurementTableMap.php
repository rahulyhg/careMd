...
use propel\propel\CareTypeUnitMeasurement;
use propel\propel\CareTypeUnitMeasurementQuery;
...
class CareTypeUnitMeasurementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeUnitMeasurementTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeUnitMeasurement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeUnitMeasurement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeUnitMeasurement');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeUnitMeasurement) { // it's a model object
