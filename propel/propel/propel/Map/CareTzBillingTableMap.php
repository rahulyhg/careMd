...
use propel\propel\CareTzBilling;
use propel\propel\CareTzBillingQuery;
...
class CareTzBillingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBilling';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBilling';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBilling');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBilling) { // it's a model object
