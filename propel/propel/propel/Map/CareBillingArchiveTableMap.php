...
use propel\propel\CareBillingArchive;
use propel\propel\CareBillingArchiveQuery;
...
class CareBillingArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareBillingArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareBillingArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareBillingArchive';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareBillingArchive');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareBillingArchive) { // it's a model object
