...
use propel\propel\CareTestFindingsChemlabCopy;
use propel\propel\CareTestFindingsChemlabCopyQuery;
...
class CareTestFindingsChemlabCopyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsChemlabCopyTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsChemlabCopy';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsChemlabCopy';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsChemlabCopy');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestFindingsChemlabCopy $obj A \propel\propel\CareTestFindingsChemlabCopy object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestFindingsChemlabCopy object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestFindingsChemlabCopy) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestFindingsChemlabCopy object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsChemlabCopy) { // it's a model object
