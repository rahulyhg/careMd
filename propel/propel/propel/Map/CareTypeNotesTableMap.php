...
use propel\propel\CareTypeNotes;
use propel\propel\CareTypeNotesQuery;
...
class CareTypeNotesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeNotesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeNotes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeNotes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeNotes');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeNotes) { // it's a model object
