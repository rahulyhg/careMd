...
use propel\propel\CareTzArvVisit;
use propel\propel\CareTzArvVisitQuery;
...
class CareTzArvVisitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvVisitTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvVisit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvVisit';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvVisit');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvVisit) { // it's a model object
