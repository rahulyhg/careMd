...
use propel\propel\CareEncounterDrgIntern;
use propel\propel\CareEncounterDrgInternQuery;
...
class CareEncounterDrgInternTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterDrgInternTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterDrgIntern';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterDrgIntern';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterDrgIntern');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterDrgIntern) { // it's a model object
