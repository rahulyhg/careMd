...
use propel\propel\CareTzArvEvents;
use propel\propel\CareTzArvEventsQuery;
...
class CareTzArvEventsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvEventsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvEvents';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvEvents';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvEvents');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvEvents) { // it's a model object
