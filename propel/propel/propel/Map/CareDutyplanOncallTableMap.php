...
use propel\propel\CareDutyplanOncall;
use propel\propel\CareDutyplanOncallQuery;
...
class CareDutyplanOncallTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareDutyplanOncallTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareDutyplanOncall';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareDutyplanOncall';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareDutyplanOncall');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareDutyplanOncall) { // it's a model object
