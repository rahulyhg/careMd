...
use propel\propel\Locations;
use propel\propel\LocationsQuery;
...
class LocationsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.LocationsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\Locations';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.Locations';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\Locations');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\Locations) { // it's a model object
