...
use propel\propel\CareTzArvEventsCode;
use propel\propel\CareTzArvEventsCodeQuery;
...
class CareTzArvEventsCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvEventsCodeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvEventsCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvEventsCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvEventsCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvEventsCode) { // it's a model object
