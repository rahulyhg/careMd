...
use propel\propel\CareBillingItem;
use propel\propel\CareBillingItemQuery;
...
class CareBillingItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareBillingItemTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareBillingItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareBillingItem';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareBillingItem');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareBillingItem) { // it's a model object
