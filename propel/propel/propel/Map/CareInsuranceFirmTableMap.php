...
use propel\propel\CareInsuranceFirm;
use propel\propel\CareInsuranceFirmQuery;
...
class CareInsuranceFirmTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareInsuranceFirmTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareInsuranceFirm';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareInsuranceFirm';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareInsuranceFirm');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareInsuranceFirm) { // it's a model object
