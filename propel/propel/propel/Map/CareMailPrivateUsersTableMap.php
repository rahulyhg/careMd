...
use propel\propel\CareMailPrivateUsers;
use propel\propel\CareMailPrivateUsersQuery;
...
class CareMailPrivateUsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMailPrivateUsersTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMailPrivateUsers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMailPrivateUsers';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMailPrivateUsers');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMailPrivateUsers) { // it's a model object
