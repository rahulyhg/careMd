...
use propel\propel\CareTzStockSupplierLists;
use propel\propel\CareTzStockSupplierListsQuery;
...
class CareTzStockSupplierListsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzStockSupplierListsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzStockSupplierLists';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzStockSupplierLists';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzStockSupplierLists');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzStockSupplierLists) { // it's a model object
