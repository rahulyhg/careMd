...
use propel\propel\CareNeonatal;
use propel\propel\CareNeonatalQuery;
...
class CareNeonatalTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareNeonatalTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareNeonatal';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareNeonatal';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareNeonatal');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareNeonatal) { // it's a model object
