...
use propel\propel\CareUnitMeasurement;
use propel\propel\CareUnitMeasurementQuery;
...
class CareUnitMeasurementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareUnitMeasurementTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareUnitMeasurement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareUnitMeasurement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareUnitMeasurement');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareUnitMeasurement) { // it's a model object
