...
use propel\propel\CareEncounterProcedure;
use propel\propel\CareEncounterProcedureQuery;
...
class CareEncounterProcedureTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterProcedureTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterProcedure';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterProcedure';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterProcedure');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterProcedure) { // it's a model object
