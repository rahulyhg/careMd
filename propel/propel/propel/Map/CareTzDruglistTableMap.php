...
use propel\propel\CareTzDruglist;
use propel\propel\CareTzDruglistQuery;
...
class CareTzDruglistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDruglistTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDruglist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDruglist';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDruglist');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDruglist) { // it's a model object
