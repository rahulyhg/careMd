...
use propel\propel\CareSteriProductsMain;
use propel\propel\CareSteriProductsMainQuery;
...
class CareSteriProductsMainTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareSteriProductsMainTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareSteriProductsMain';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareSteriProductsMain';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareSteriProductsMain');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareSteriProductsMain) { // it's a model object
