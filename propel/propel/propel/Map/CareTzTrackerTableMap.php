...
use propel\propel\CareTzTracker;
use propel\propel\CareTzTrackerQuery;
...
class CareTzTrackerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzTrackerTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzTracker';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzTracker';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzTracker');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzTracker) { // it's a model object
