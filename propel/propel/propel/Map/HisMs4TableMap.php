...
use propel\propel\HisMs4;
use propel\propel\HisMs4Query;
...
class HisMs4TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.HisMs4TableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\HisMs4';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.HisMs4';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\HisMs4');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\HisMs4) { // it's a model object
