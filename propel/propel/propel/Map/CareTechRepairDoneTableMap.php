...
use propel\propel\CareTechRepairDone;
use propel\propel\CareTechRepairDoneQuery;
...
class CareTechRepairDoneTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTechRepairDoneTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTechRepairDone';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTechRepairDone';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTechRepairDone');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTechRepairDone $obj A \propel\propel\CareTechRepairDone object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTechRepairDone object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTechRepairDone) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTechRepairDone object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTechRepairDone) { // it's a model object
