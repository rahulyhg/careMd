...
use propel\propel\CareTzLaboratoryParam;
use propel\propel\CareTzLaboratoryParamQuery;
...
class CareTzLaboratoryParamTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzLaboratoryParamTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzLaboratoryParam';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzLaboratoryParam';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzLaboratoryParam');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzLaboratoryParam) { // it's a model object
