...
use propel\propel\CareTzEyeHistory5;
use propel\propel\CareTzEyeHistory5Query;
...
class CareTzEyeHistory5TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeHistory5TableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeHistory5';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeHistory5';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeHistory5');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeHistory5) { // it's a model object
