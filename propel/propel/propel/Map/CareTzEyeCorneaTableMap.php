...
use propel\propel\CareTzEyeCornea;
use propel\propel\CareTzEyeCorneaQuery;
...
class CareTzEyeCorneaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeCorneaTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeCornea';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeCornea';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeCornea');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeCornea) { // it's a model object
