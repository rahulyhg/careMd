...
use propel\propel\CareTzArvEducation;
use propel\propel\CareTzArvEducationQuery;
...
class CareTzArvEducationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvEducationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvEducation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvEducation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvEducation');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvEducation) { // it's a model object
