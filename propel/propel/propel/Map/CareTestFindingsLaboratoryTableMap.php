...
use propel\propel\CareTestFindingsLaboratory;
use propel\propel\CareTestFindingsLaboratoryQuery;
...
class CareTestFindingsLaboratoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsLaboratoryTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsLaboratory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsLaboratory';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsLaboratory');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestFindingsLaboratory $obj A \propel\propel\CareTestFindingsLaboratory object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestFindingsLaboratory object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestFindingsLaboratory) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestFindingsLaboratory object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsLaboratory) { // it's a model object
