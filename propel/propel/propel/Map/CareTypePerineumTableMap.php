...
use propel\propel\CareTypePerineum;
use propel\propel\CareTypePerineumQuery;
...
class CareTypePerineumTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypePerineumTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypePerineum';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypePerineum';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypePerineum');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypePerineum) { // it's a model object
