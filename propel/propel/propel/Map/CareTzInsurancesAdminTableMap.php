...
use propel\propel\CareTzInsurancesAdmin;
use propel\propel\CareTzInsurancesAdminQuery;
...
class CareTzInsurancesAdminTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzInsurancesAdminTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzInsurancesAdmin';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzInsurancesAdmin';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzInsurancesAdmin');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzInsurancesAdmin) { // it's a model object
