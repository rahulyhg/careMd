...
use propel\propel\CareTzVillage;
use propel\propel\CareTzVillageQuery;
...
class CareTzVillageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzVillageTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzVillage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzVillage';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzVillage');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzVillage) { // it's a model object
