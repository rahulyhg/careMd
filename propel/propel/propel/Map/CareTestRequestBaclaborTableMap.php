...
use propel\propel\CareTestRequestBaclabor;
use propel\propel\CareTestRequestBaclaborQuery;
...
class CareTestRequestBaclaborTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestBaclaborTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestBaclabor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestBaclabor';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestBaclabor');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestBaclabor) { // it's a model object
