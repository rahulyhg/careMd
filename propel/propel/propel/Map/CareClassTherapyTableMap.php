...
use propel\propel\CareClassTherapy;
use propel\propel\CareClassTherapyQuery;
...
class CareClassTherapyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareClassTherapyTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareClassTherapy';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareClassTherapy';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareClassTherapy');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareClassTherapy) { // it's a model object
