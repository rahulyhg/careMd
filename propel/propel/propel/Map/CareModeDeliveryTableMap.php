...
use propel\propel\CareModeDelivery;
use propel\propel\CareModeDeliveryQuery;
...
class CareModeDeliveryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareModeDeliveryTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareModeDelivery';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareModeDelivery';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareModeDelivery');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareModeDelivery) { // it's a model object
