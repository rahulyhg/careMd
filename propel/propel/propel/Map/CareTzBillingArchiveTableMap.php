...
use propel\propel\CareTzBillingArchive;
use propel\propel\CareTzBillingArchiveQuery;
...
class CareTzBillingArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingArchive';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingArchive');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingArchive) { // it's a model object
