...
use propel\propel\CareTzDrugsandservices;
use propel\propel\CareTzDrugsandservicesQuery;
...
class CareTzDrugsandservicesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDrugsandservicesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDrugsandservices';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDrugsandservices';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDrugsandservices');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDrugsandservices) { // it's a model object
