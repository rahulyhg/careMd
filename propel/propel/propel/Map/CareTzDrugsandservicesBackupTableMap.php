...
use propel\propel\CareTzDrugsandservicesBackup;
use propel\propel\CareTzDrugsandservicesBackupQuery;
...
class CareTzDrugsandservicesBackupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDrugsandservicesBackupTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDrugsandservicesBackup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDrugsandservicesBackup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDrugsandservicesBackup');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDrugsandservicesBackup) { // it's a model object
