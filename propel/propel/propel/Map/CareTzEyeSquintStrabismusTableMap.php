...
use propel\propel\CareTzEyeSquintStrabismus;
use propel\propel\CareTzEyeSquintStrabismusQuery;
...
class CareTzEyeSquintStrabismusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeSquintStrabismusTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeSquintStrabismus';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeSquintStrabismus';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeSquintStrabismus');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeSquintStrabismus) { // it's a model object
