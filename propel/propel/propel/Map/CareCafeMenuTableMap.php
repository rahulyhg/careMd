...
use propel\propel\CareCafeMenu;
use propel\propel\CareCafeMenuQuery;
...
class CareCafeMenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCafeMenuTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCafeMenu';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCafeMenu';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCafeMenu');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCafeMenu) { // it's a model object
