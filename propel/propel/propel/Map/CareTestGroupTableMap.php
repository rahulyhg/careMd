...
use propel\propel\CareTestGroup;
use propel\propel\CareTestGroupQuery;
...
class CareTestGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestGroupTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestGroup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestGroup');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestGroup $obj A \propel\propel\CareTestGroup object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestGroup object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestGroup) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestGroup object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestGroup) { // it's a model object
