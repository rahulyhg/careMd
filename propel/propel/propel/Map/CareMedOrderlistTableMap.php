...
use propel\propel\CareMedOrderlist;
use propel\propel\CareMedOrderlistQuery;
...
class CareMedOrderlistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMedOrderlistTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMedOrderlist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMedOrderlist';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMedOrderlist');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMedOrderlist) { // it's a model object
