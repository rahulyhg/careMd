...
use propel\propel\CareDrgIntern;
use propel\propel\CareDrgInternQuery;
...
class CareDrgInternTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareDrgInternTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareDrgIntern';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareDrgIntern';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareDrgIntern');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareDrgIntern) { // it's a model object
