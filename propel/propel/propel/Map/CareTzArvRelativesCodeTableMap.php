...
use propel\propel\CareTzArvRelativesCode;
use propel\propel\CareTzArvRelativesCodeQuery;
...
class CareTzArvRelativesCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvRelativesCodeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvRelativesCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvRelativesCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvRelativesCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvRelativesCode) { // it's a model object
