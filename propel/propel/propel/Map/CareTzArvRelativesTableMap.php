...
use propel\propel\CareTzArvRelatives;
use propel\propel\CareTzArvRelativesQuery;
...
class CareTzArvRelativesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvRelativesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvRelatives';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvRelatives';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvRelatives');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTzArvRelatives $obj A \propel\propel\CareTzArvRelatives object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTzArvRelatives object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTzArvRelatives) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTzArvRelatives object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvRelatives) { // it's a model object
