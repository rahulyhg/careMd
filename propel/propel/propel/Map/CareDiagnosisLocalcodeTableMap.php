...
use propel\propel\CareDiagnosisLocalcode;
use propel\propel\CareDiagnosisLocalcodeQuery;
...
class CareDiagnosisLocalcodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareDiagnosisLocalcodeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareDiagnosisLocalcode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareDiagnosisLocalcode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareDiagnosisLocalcode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareDiagnosisLocalcode) { // it's a model object
