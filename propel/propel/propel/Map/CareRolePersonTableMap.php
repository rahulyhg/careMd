...
use propel\propel\CareRolePerson;
use propel\propel\CareRolePersonQuery;
...
class CareRolePersonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareRolePersonTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareRolePerson';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareRolePerson';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareRolePerson');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareRolePerson $obj A \propel\propel\CareRolePerson object.
     ...
     *
     * @param mixed $value A \propel\propel\CareRolePerson object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareRolePerson) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareRolePerson object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareRolePerson) { // it's a model object
