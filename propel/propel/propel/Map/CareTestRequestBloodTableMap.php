...
use propel\propel\CareTestRequestBlood;
use propel\propel\CareTestRequestBloodQuery;
...
class CareTestRequestBloodTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestBloodTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestBlood';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestBlood';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestBlood');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestBlood) { // it's a model object
