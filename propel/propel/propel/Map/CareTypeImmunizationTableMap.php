...
use propel\propel\CareTypeImmunization;
use propel\propel\CareTypeImmunizationQuery;
...
class CareTypeImmunizationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeImmunizationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeImmunization';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeImmunization';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeImmunization');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeImmunization) { // it's a model object
