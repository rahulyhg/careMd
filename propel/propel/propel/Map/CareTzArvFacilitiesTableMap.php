...
use propel\propel\CareTzArvFacilities;
use propel\propel\CareTzArvFacilitiesQuery;
...
class CareTzArvFacilitiesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvFacilitiesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvFacilities';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvFacilities';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvFacilities');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTzArvFacilities $obj A \propel\propel\CareTzArvFacilities object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTzArvFacilities object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTzArvFacilities) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTzArvFacilities object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvFacilities) { // it's a model object
