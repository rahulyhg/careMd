...
use propel\propel\CareTestParam;
use propel\propel\CareTestParamQuery;
...
class CareTestParamTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestParamTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestParam';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestParam';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestParam');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestParam $obj A \propel\propel\CareTestParam object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestParam object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestParam) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestParam object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestParam) { // it's a model object
