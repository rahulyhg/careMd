...
use propel\propel\CareTzDrugsandservicesUpdate;
use propel\propel\CareTzDrugsandservicesUpdateQuery;
...
class CareTzDrugsandservicesUpdateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDrugsandservicesUpdateTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDrugsandservicesUpdate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDrugsandservicesUpdate';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDrugsandservicesUpdate');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDrugsandservicesUpdate) { // it's a model object
