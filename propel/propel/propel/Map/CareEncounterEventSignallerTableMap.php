...
use propel\propel\CareEncounterEventSignaller;
use propel\propel\CareEncounterEventSignallerQuery;
...
class CareEncounterEventSignallerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterEventSignallerTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterEventSignaller';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterEventSignaller';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterEventSignaller');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterEventSignaller) { // it's a model object
