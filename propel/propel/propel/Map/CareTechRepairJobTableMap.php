...
use propel\propel\CareTechRepairJob;
use propel\propel\CareTechRepairJobQuery;
...
class CareTechRepairJobTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTechRepairJobTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTechRepairJob';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTechRepairJob';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTechRepairJob');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTechRepairJob) { // it's a model object
