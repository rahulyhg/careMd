...
use propel\propel\HisSwelabAlfa;
use propel\propel\HisSwelabAlfaQuery;
...
class HisSwelabAlfaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.HisSwelabAlfaTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\HisSwelabAlfa';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.HisSwelabAlfa';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\HisSwelabAlfa');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\HisSwelabAlfa) { // it's a model object
