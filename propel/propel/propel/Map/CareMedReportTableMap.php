...
use propel\propel\CareMedReport;
use propel\propel\CareMedReportQuery;
...
class CareMedReportTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMedReportTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMedReport';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMedReport';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMedReport');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMedReport) { // it's a model object
