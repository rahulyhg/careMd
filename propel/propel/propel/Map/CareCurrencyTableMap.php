...
use propel\propel\CareCurrency;
use propel\propel\CareCurrencyQuery;
...
class CareCurrencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCurrencyTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCurrency';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCurrency';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCurrency');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCurrency) { // it's a model object
