...
use propel\propel\CareTestRequestChemlaborSub;
use propel\propel\CareTestRequestChemlaborSubQuery;
...
class CareTestRequestChemlaborSubTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestChemlaborSubTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestChemlaborSub';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestChemlaborSub';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestChemlaborSub');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestChemlaborSub) { // it's a model object
