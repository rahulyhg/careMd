...
use propel\propel\CareTzArvEducationTopic;
use propel\propel\CareTzArvEducationTopicQuery;
...
class CareTzArvEducationTopicTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvEducationTopicTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvEducationTopic';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvEducationTopic';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvEducationTopic');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvEducationTopic) { // it's a model object
