...
use propel\propel\CareTzArvTreatmentSupporter;
use propel\propel\CareTzArvTreatmentSupporterQuery;
...
class CareTzArvTreatmentSupporterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvTreatmentSupporterTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvTreatmentSupporter';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvTreatmentSupporter';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvTreatmentSupporter');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvTreatmentSupporter) { // it's a model object
