...
use propel\propel\CareEncounterOp;
use propel\propel\CareEncounterOpQuery;
...
class CareEncounterOpTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterOpTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterOp';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterOp';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterOp');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterOp) { // it's a model object
