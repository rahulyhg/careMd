...
use propel\propel\CareTzCompany;
use propel\propel\CareTzCompanyQuery;
...
class CareTzCompanyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzCompanyTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzCompany';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzCompany';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzCompany');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzCompany) { // it's a model object
