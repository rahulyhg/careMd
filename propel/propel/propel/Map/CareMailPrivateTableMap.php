...
use propel\propel\CareMailPrivate;
use propel\propel\CareMailPrivateQuery;
...
class CareMailPrivateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMailPrivateTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMailPrivate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMailPrivate';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMailPrivate');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMailPrivate) { // it's a model object
