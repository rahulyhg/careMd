...
use propel\propel\CareTzEyeVisualacuity;
use propel\propel\CareTzEyeVisualacuityQuery;
...
class CareTzEyeVisualacuityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeVisualacuityTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeVisualacuity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeVisualacuity';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeVisualacuity');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeVisualacuity) { // it's a model object
