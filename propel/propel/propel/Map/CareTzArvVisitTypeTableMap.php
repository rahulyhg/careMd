...
use propel\propel\CareTzArvVisitType;
use propel\propel\CareTzArvVisitTypeQuery;
...
class CareTzArvVisitTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvVisitTypeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvVisitType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvVisitType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvVisitType');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvVisitType) { // it's a model object
