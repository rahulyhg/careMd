...
use propel\propel\CareTestRequestLaboratoryTasks;
use propel\propel\CareTestRequestLaboratoryTasksQuery;
...
class CareTestRequestLaboratoryTasksTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestLaboratoryTasksTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestLaboratoryTasks';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestLaboratoryTasks';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestLaboratoryTasks');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestLaboratoryTasks) { // it's a model object
