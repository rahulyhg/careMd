...
use propel\propel\CarePharmaOrderlist;
use propel\propel\CarePharmaOrderlistQuery;
...
class CarePharmaOrderlistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePharmaOrderlistTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePharmaOrderlist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePharmaOrderlist';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePharmaOrderlist');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CarePharmaOrderlist $obj A \propel\propel\CarePharmaOrderlist object.
     ...
     *
     * @param mixed $value A \propel\propel\CarePharmaOrderlist object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CarePharmaOrderlist) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CarePharmaOrderlist object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePharmaOrderlist) { // it's a model object
