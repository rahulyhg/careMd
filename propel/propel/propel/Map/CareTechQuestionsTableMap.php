...
use propel\propel\CareTechQuestions;
use propel\propel\CareTechQuestionsQuery;
...
class CareTechQuestionsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTechQuestionsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTechQuestions';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTechQuestions';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTechQuestions');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTechQuestions) { // it's a model object
