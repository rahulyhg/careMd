...
use propel\propel\CarePersonOtherNumber;
use propel\propel\CarePersonOtherNumberQuery;
...
class CarePersonOtherNumberTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePersonOtherNumberTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePersonOtherNumber';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePersonOtherNumber';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePersonOtherNumber');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePersonOtherNumber) { // it's a model object
