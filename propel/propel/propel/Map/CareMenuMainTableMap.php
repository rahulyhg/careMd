...
use propel\propel\CareMenuMain;
use propel\propel\CareMenuMainQuery;
...
class CareMenuMainTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMenuMainTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMenuMain';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMenuMain';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMenuMain');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMenuMain) { // it's a model object
