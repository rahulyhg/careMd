...
use propel\propel\CareEncounterImmunization;
use propel\propel\CareEncounterImmunizationQuery;
...
class CareEncounterImmunizationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterImmunizationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterImmunization';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterImmunization';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterImmunization');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterImmunization) { // it's a model object
