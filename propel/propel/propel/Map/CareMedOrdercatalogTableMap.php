...
use propel\propel\CareMedOrdercatalog;
use propel\propel\CareMedOrdercatalogQuery;
...
class CareMedOrdercatalogTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMedOrdercatalogTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMedOrdercatalog';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMedOrdercatalog';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMedOrdercatalog');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMedOrdercatalog) { // it's a model object
