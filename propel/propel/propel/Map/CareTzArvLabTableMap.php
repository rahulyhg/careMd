...
use propel\propel\CareTzArvLab;
use propel\propel\CareTzArvLabQuery;
...
class CareTzArvLabTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvLabTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvLab';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvLab';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvLab');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvLab) { // it's a model object
