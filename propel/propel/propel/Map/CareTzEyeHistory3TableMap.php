...
use propel\propel\CareTzEyeHistory3;
use propel\propel\CareTzEyeHistory3Query;
...
class CareTzEyeHistory3TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeHistory3TableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeHistory3';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeHistory3';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeHistory3');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeHistory3) { // it's a model object
