...
use propel\propel\CareAddressCitytown;
use propel\propel\CareAddressCitytownQuery;
...
class CareAddressCitytownTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareAddressCitytownTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareAddressCitytown';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareAddressCitytown';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareAddressCitytown');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareAddressCitytown) { // it's a model object
