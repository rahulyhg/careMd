...
use propel\propel\CareDepartment;
use propel\propel\CareDepartmentQuery;
...
class CareDepartmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareDepartmentTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareDepartment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareDepartment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareDepartment');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareDepartment) { // it's a model object
