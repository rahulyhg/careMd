...
use propel\propel\CareTestRequestRadio;
use propel\propel\CareTestRequestRadioQuery;
...
class CareTestRequestRadioTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestRadioTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestRadio';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestRadio';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestRadio');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestRadio) { // it's a model object
