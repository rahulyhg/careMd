...
use propel\propel\CareIcd10En;
use propel\propel\CareIcd10EnQuery;
...
class CareIcd10EnTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareIcd10EnTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareIcd10En';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareIcd10En';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareIcd10En');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareIcd10En) { // it's a model object
