...
use propel\propel\CareEncounterObstetric;
use propel\propel\CareEncounterObstetricQuery;
...
class CareEncounterObstetricTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterObstetricTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterObstetric';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterObstetric';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterObstetric');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterObstetric) { // it's a model object
