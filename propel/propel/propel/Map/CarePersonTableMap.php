...
use propel\propel\CarePerson;
use propel\propel\CarePersonQuery;
...
class CarePersonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePersonTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePerson';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePerson';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePerson');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePerson) { // it's a model object
