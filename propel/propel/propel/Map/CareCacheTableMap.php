...
use propel\propel\CareCache;
use propel\propel\CareCacheQuery;
...
class CareCacheTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCacheTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCache';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCache';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCache');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCache) { // it's a model object
