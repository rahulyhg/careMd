...
use propel\propel\CareComplication;
use propel\propel\CareComplicationQuery;
...
class CareComplicationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareComplicationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareComplication';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareComplication';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareComplication');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareComplication) { // it's a model object
