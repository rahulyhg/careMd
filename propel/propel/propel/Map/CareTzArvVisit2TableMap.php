...
use propel\propel\CareTzArvVisit2;
use propel\propel\CareTzArvVisit2Query;
...
class CareTzArvVisit2TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvVisit2TableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvVisit2';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvVisit2';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvVisit2');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvVisit2) { // it's a model object
