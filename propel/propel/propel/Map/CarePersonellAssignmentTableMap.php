...
use propel\propel\CarePersonellAssignment;
use propel\propel\CarePersonellAssignmentQuery;
...
class CarePersonellAssignmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePersonellAssignmentTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePersonellAssignment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePersonellAssignment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePersonellAssignment');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CarePersonellAssignment $obj A \propel\propel\CarePersonellAssignment object.
     ...
     *
     * @param mixed $value A \propel\propel\CarePersonellAssignment object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CarePersonellAssignment) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CarePersonellAssignment object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePersonellAssignment) { // it's a model object
