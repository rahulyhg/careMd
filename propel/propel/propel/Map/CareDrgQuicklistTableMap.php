...
use propel\propel\CareDrgQuicklist;
use propel\propel\CareDrgQuicklistQuery;
...
class CareDrgQuicklistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareDrgQuicklistTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareDrgQuicklist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareDrgQuicklist';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareDrgQuicklist');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareDrgQuicklist) { // it's a model object
