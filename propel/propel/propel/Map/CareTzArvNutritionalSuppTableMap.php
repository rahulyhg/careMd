...
use propel\propel\CareTzArvNutritionalSupp;
use propel\propel\CareTzArvNutritionalSuppQuery;
...
class CareTzArvNutritionalSuppTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvNutritionalSuppTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvNutritionalSupp';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvNutritionalSupp';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvNutritionalSupp');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvNutritionalSupp) { // it's a model object
