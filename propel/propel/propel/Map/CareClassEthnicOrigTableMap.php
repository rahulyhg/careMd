...
use propel\propel\CareClassEthnicOrig;
use propel\propel\CareClassEthnicOrigQuery;
...
class CareClassEthnicOrigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareClassEthnicOrigTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareClassEthnicOrig';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareClassEthnicOrig';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareClassEthnicOrig');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareClassEthnicOrig) { // it's a model object
