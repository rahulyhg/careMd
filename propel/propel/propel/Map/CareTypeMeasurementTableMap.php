...
use propel\propel\CareTypeMeasurement;
use propel\propel\CareTypeMeasurementQuery;
...
class CareTypeMeasurementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeMeasurementTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeMeasurement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeMeasurement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeMeasurement');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeMeasurement) { // it's a model object
