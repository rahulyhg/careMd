...
use propel\propel\CareTypeColor;
use propel\propel\CareTypeColorQuery;
...
class CareTypeColorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeColorTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeColor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeColor';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeColor');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeColor) { // it's a model object
