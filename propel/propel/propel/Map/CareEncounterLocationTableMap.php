...
use propel\propel\CareEncounterLocation;
use propel\propel\CareEncounterLocationQuery;
...
class CareEncounterLocationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterLocationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterLocation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterLocation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterLocation');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareEncounterLocation $obj A \propel\propel\CareEncounterLocation object.
     ...
     *
     * @param mixed $value A \propel\propel\CareEncounterLocation object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareEncounterLocation) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareEncounterLocation object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterLocation) { // it's a model object
