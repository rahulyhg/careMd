...
use propel\propel\CareEncounterPrescription;
use propel\propel\CareEncounterPrescriptionQuery;
...
class CareEncounterPrescriptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterPrescriptionTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterPrescription';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterPrescription';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterPrescription');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterPrescription) { // it's a model object
