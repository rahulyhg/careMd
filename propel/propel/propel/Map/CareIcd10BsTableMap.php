...
use propel\propel\CareIcd10Bs;
use propel\propel\CareIcd10BsQuery;
...
class CareIcd10BsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareIcd10BsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareIcd10Bs';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareIcd10Bs';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareIcd10Bs');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareIcd10Bs) { // it's a model object
