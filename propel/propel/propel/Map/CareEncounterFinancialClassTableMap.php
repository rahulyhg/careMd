...
use propel\propel\CareEncounterFinancialClass;
use propel\propel\CareEncounterFinancialClassQuery;
...
class CareEncounterFinancialClassTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterFinancialClassTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterFinancialClass';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterFinancialClass';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterFinancialClass');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterFinancialClass) { // it's a model object
