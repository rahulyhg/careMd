...
use propel\propel\CareTzEyeLens;
use propel\propel\CareTzEyeLensQuery;
...
class CareTzEyeLensTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeLensTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeLens';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeLens';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeLens');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeLens) { // it's a model object
