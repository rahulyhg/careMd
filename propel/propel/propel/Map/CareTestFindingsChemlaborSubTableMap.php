...
use propel\propel\CareTestFindingsChemlaborSub;
use propel\propel\CareTestFindingsChemlaborSubQuery;
...
class CareTestFindingsChemlaborSubTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsChemlaborSubTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsChemlaborSub';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsChemlaborSub';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsChemlaborSub');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsChemlaborSub) { // it's a model object
