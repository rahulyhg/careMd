...
use propel\propel\CareTzSupplierDeatail;
use propel\propel\CareTzSupplierDeatailQuery;
...
class CareTzSupplierDeatailTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzSupplierDeatailTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzSupplierDeatail';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzSupplierDeatail';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzSupplierDeatail');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzSupplierDeatail) { // it's a model object
