...
use propel\propel\CareTzArvChairman;
use propel\propel\CareTzArvChairmanQuery;
...
class CareTzArvChairmanTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvChairmanTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvChairman';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvChairman';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvChairman');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvChairman) { // it's a model object
