...
use propel\propel\CareRegistry;
use propel\propel\CareRegistryQuery;
...
class CareRegistryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareRegistryTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareRegistry';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareRegistry';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareRegistry');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareRegistry) { // it's a model object
