...
use propel\propel\CareTzBillingArchiveElem;
use propel\propel\CareTzBillingArchiveElemQuery;
...
class CareTzBillingArchiveElemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingArchiveElemTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingArchiveElem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingArchiveElem';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingArchiveElem');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingArchiveElem) { // it's a model object
