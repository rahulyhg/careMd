...
use propel\propel\CareTzEyeConjunctiva;
use propel\propel\CareTzEyeConjunctivaQuery;
...
class CareTzEyeConjunctivaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeConjunctivaTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeConjunctiva';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeConjunctiva';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeConjunctiva');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeConjunctiva) { // it's a model object
