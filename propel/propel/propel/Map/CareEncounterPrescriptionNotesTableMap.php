...
use propel\propel\CareEncounterPrescriptionNotes;
use propel\propel\CareEncounterPrescriptionNotesQuery;
...
class CareEncounterPrescriptionNotesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterPrescriptionNotesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterPrescriptionNotes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterPrescriptionNotes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterPrescriptionNotes');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterPrescriptionNotes) { // it's a model object
