...
use propel\propel\CareMedProductsMain;
use propel\propel\CareMedProductsMainQuery;
...
class CareMedProductsMainTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMedProductsMainTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMedProductsMain';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMedProductsMain';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMedProductsMain');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMedProductsMain) { // it's a model object
