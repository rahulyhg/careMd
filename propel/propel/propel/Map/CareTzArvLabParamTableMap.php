...
use propel\propel\CareTzArvLabParam;
use propel\propel\CareTzArvLabParamQuery;
...
class CareTzArvLabParamTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvLabParamTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvLabParam';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvLabParam';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvLabParam');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvLabParam) { // it's a model object
