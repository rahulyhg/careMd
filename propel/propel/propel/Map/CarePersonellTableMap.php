...
use propel\propel\CarePersonell;
use propel\propel\CarePersonellQuery;
...
class CarePersonellTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePersonellTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePersonell';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePersonell';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePersonell');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CarePersonell $obj A \propel\propel\CarePersonell object.
     ...
     *
     * @param mixed $value A \propel\propel\CarePersonell object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CarePersonell) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CarePersonell object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePersonell) { // it's a model object
