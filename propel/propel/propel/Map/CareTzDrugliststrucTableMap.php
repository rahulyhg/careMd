...
use propel\propel\CareTzDrugliststruc;
use propel\propel\CareTzDrugliststrucQuery;
...
class CareTzDrugliststrucTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDrugliststrucTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDrugliststruc';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDrugliststruc';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDrugliststruc');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDrugliststruc) { // it's a model object
