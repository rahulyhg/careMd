...
use propel\propel\CareTzArvStatus;
use propel\propel\CareTzArvStatusQuery;
...
class CareTzArvStatusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvStatusTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvStatus';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvStatus';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvStatus');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvStatus) { // it's a model object
