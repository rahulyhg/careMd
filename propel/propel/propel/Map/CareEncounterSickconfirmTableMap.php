...
use propel\propel\CareEncounterSickconfirm;
use propel\propel\CareEncounterSickconfirmQuery;
...
class CareEncounterSickconfirmTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterSickconfirmTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterSickconfirm';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterSickconfirm';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterSickconfirm');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterSickconfirm) { // it's a model object
