...
use propel\propel\CareTestFindingsPatho;
use propel\propel\CareTestFindingsPathoQuery;
...
class CareTestFindingsPathoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsPathoTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsPatho';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsPatho';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsPatho');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestFindingsPatho $obj A \propel\propel\CareTestFindingsPatho object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestFindingsPatho object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestFindingsPatho) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestFindingsPatho object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsPatho) { // it's a model object
