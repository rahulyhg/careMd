...
use propel\propel\CareTypeFeeding;
use propel\propel\CareTypeFeedingQuery;
...
class CareTypeFeedingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeFeedingTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeFeeding';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeFeeding';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeFeeding');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeFeeding) { // it's a model object
