...
use propel\propel\CareMenuSub;
use propel\propel\CareMenuSubQuery;
...
class CareMenuSubTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMenuSubTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMenuSub';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMenuSub';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMenuSub');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMenuSub) { // it's a model object
