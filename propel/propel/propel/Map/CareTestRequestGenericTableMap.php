...
use propel\propel\CareTestRequestGeneric;
use propel\propel\CareTestRequestGenericQuery;
...
class CareTestRequestGenericTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestGenericTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestGeneric';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestGeneric';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestGeneric');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestGeneric) { // it's a model object
