...
use propel\propel\CareBillingBill;
use propel\propel\CareBillingBillQuery;
...
class CareBillingBillTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareBillingBillTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareBillingBill';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareBillingBill';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareBillingBill');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareBillingBill) { // it's a model object
