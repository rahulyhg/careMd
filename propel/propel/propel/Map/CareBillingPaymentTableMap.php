...
use propel\propel\CareBillingPayment;
use propel\propel\CareBillingPaymentQuery;
...
class CareBillingPaymentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareBillingPaymentTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareBillingPayment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareBillingPayment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareBillingPayment');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareBillingPayment) { // it's a model object
