...
use propel\propel\CareBillingFinal;
use propel\propel\CareBillingFinalQuery;
...
class CareBillingFinalTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareBillingFinalTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareBillingFinal';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareBillingFinal';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareBillingFinal');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareBillingFinal) { // it's a model object
