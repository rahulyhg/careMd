...
use propel\propel\CareCategoryDiagnosis;
use propel\propel\CareCategoryDiagnosisQuery;
...
class CareCategoryDiagnosisTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCategoryDiagnosisTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCategoryDiagnosis';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCategoryDiagnosis';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCategoryDiagnosis');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCategoryDiagnosis) { // it's a model object
