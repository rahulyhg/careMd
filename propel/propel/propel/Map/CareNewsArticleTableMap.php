...
use propel\propel\CareNewsArticle;
use propel\propel\CareNewsArticleQuery;
...
class CareNewsArticleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareNewsArticleTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareNewsArticle';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareNewsArticle';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareNewsArticle');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareNewsArticle) { // it's a model object
