...
use propel\propel\CareEncounterDiagnosticsReport;
use propel\propel\CareEncounterDiagnosticsReportQuery;
...
class CareEncounterDiagnosticsReportTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterDiagnosticsReportTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterDiagnosticsReport';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterDiagnosticsReport';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterDiagnosticsReport');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareEncounterDiagnosticsReport $obj A \propel\propel\CareEncounterDiagnosticsReport object.
     ...
     *
     * @param mixed $value A \propel\propel\CareEncounterDiagnosticsReport object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareEncounterDiagnosticsReport) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareEncounterDiagnosticsReport object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterDiagnosticsReport) { // it's a model object
