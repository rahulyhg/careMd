...
use propel\propel\CareTzArvDistricts;
use propel\propel\CareTzArvDistrictsQuery;
...
class CareTzArvDistrictsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvDistrictsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvDistricts';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvDistricts';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvDistricts');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTzArvDistricts $obj A \propel\propel\CareTzArvDistricts object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTzArvDistricts object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTzArvDistricts) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTzArvDistricts object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvDistricts) { // it's a model object
