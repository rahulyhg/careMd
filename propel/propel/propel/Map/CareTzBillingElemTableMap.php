...
use propel\propel\CareTzBillingElem;
use propel\propel\CareTzBillingElemQuery;
...
class CareTzBillingElemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingElemTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingElem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingElem';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingElem');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingElem) { // it's a model object
