...
use propel\propel\CareEncounterImage;
use propel\propel\CareEncounterImageQuery;
...
class CareEncounterImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterImageTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterImage';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterImage');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterImage) { // it's a model object
