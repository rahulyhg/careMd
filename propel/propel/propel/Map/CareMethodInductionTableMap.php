...
use propel\propel\CareMethodInduction;
use propel\propel\CareMethodInductionQuery;
...
class CareMethodInductionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareMethodInductionTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareMethodInduction';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareMethodInduction';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareMethodInduction');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareMethodInduction) { // it's a model object
