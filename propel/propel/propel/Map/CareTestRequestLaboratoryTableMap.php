...
use propel\propel\CareTestRequestLaboratory;
use propel\propel\CareTestRequestLaboratoryQuery;
...
class CareTestRequestLaboratoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestLaboratoryTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestLaboratory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestLaboratory';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestLaboratory');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestLaboratory) { // it's a model object
