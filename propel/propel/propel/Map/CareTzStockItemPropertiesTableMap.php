...
use propel\propel\CareTzStockItemProperties;
use propel\propel\CareTzStockItemPropertiesQuery;
...
class CareTzStockItemPropertiesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzStockItemPropertiesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzStockItemProperties';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzStockItemProperties';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzStockItemProperties');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzStockItemProperties) { // it's a model object
