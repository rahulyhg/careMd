...
use propel\propel\CarePharmaOrdercatalog;
use propel\propel\CarePharmaOrdercatalogQuery;
...
class CarePharmaOrdercatalogTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePharmaOrdercatalogTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePharmaOrdercatalog';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePharmaOrdercatalog';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePharmaOrdercatalog');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePharmaOrdercatalog) { // it's a model object
