...
use propel\propel\CareTzLaboratory;
use propel\propel\CareTzLaboratoryQuery;
...
class CareTzLaboratoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzLaboratoryTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzLaboratory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzLaboratory';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzLaboratory');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzLaboratory) { // it's a model object
