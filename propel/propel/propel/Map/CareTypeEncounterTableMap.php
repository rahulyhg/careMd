...
use propel\propel\CareTypeEncounter;
use propel\propel\CareTypeEncounterQuery;
...
class CareTypeEncounterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeEncounterTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeEncounter';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeEncounter';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeEncounter');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeEncounter) { // it's a model object
