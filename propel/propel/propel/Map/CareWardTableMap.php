...
use propel\propel\CareWard;
use propel\propel\CareWardQuery;
...
class CareWardTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareWardTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareWard';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareWard';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareWard');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareWard) { // it's a model object
