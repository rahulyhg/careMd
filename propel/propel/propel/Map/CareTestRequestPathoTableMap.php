...
use propel\propel\CareTestRequestPatho;
use propel\propel\CareTestRequestPathoQuery;
...
class CareTestRequestPathoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestRequestPathoTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestRequestPatho';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestRequestPatho';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestRequestPatho');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestRequestPatho) { // it's a model object
