...
use propel\propel\CareTypeLocalization;
use propel\propel\CareTypeLocalizationQuery;
...
class CareTypeLocalizationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeLocalizationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeLocalization';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeLocalization';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeLocalization');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeLocalization) { // it's a model object
