...
use propel\propel\CareTypeDuty;
use propel\propel\CareTypeDutyQuery;
...
class CareTypeDutyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeDutyTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeDuty';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeDuty';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeDuty');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeDuty) { // it's a model object
