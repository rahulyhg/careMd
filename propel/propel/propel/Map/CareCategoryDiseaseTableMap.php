...
use propel\propel\CareCategoryDisease;
use propel\propel\CareCategoryDiseaseQuery;
...
class CareCategoryDiseaseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCategoryDiseaseTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCategoryDisease';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCategoryDisease';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCategoryDisease');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCategoryDisease) { // it's a model object
