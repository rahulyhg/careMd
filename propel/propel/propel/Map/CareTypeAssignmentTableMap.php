...
use propel\propel\CareTypeAssignment;
use propel\propel\CareTypeAssignmentQuery;
...
class CareTypeAssignmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTypeAssignmentTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTypeAssignment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTypeAssignment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTypeAssignment');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTypeAssignment) { // it's a model object
