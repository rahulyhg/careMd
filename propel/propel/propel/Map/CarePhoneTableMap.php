...
use propel\propel\CarePhone;
use propel\propel\CarePhoneQuery;
...
class CarePhoneTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CarePhoneTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CarePhone';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CarePhone';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CarePhone');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CarePhone $obj A \propel\propel\CarePhone object.
     ...
     *
     * @param mixed $value A \propel\propel\CarePhone object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CarePhone) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CarePhone object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CarePhone) { // it's a model object
