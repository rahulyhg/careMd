...
use propel\propel\CareTzArvRegimenCode;
use propel\propel\CareTzArvRegimenCodeQuery;
...
class CareTzArvRegimenCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvRegimenCodeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvRegimenCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvRegimenCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvRegimenCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvRegimenCode) { // it's a model object
