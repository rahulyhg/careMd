...
use propel\propel\CareIcd10Es;
use propel\propel\CareIcd10EsQuery;
...
class CareIcd10EsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareIcd10EsTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareIcd10Es';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareIcd10Es';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareIcd10Es');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareIcd10Es) { // it's a model object
