...
use propel\propel\CareTzBillingElemAdvance;
use propel\propel\CareTzBillingElemAdvanceQuery;
...
class CareTzBillingElemAdvanceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingElemAdvanceTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingElemAdvance';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingElemAdvance';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingElemAdvance');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingElemAdvance) { // it's a model object
