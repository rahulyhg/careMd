...
use propel\propel\CareTzReligion;
use propel\propel\CareTzReligionQuery;
...
class CareTzReligionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzReligionTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzReligion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzReligion';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzReligion');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzReligion) { // it's a model object
