...
use propel\propel\CareOps301De;
use propel\propel\CareOps301DeQuery;
...
class CareOps301DeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareOps301DeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareOps301De';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareOps301De';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareOps301De');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareOps301De) { // it's a model object
