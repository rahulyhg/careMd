...
use propel\propel\CareTzIcd10Quicklist;
use propel\propel\CareTzIcd10QuicklistQuery;
...
class CareTzIcd10QuicklistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzIcd10QuicklistTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzIcd10Quicklist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzIcd10Quicklist';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzIcd10Quicklist');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzIcd10Quicklist) { // it's a model object
