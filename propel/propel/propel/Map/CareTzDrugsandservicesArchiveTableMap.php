...
use propel\propel\CareTzDrugsandservicesArchive;
use propel\propel\CareTzDrugsandservicesArchiveQuery;
...
class CareTzDrugsandservicesArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzDrugsandservicesArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzDrugsandservicesArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzDrugsandservicesArchive';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzDrugsandservicesArchive');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzDrugsandservicesArchive) { // it's a model object
