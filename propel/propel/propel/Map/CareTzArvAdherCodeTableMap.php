...
use propel\propel\CareTzArvAdherCode;
use propel\propel\CareTzArvAdherCodeQuery;
...
class CareTzArvAdherCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvAdherCodeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvAdherCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvAdherCode';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvAdherCode');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvAdherCode) { // it's a model object
