...
use propel\propel\CareTzArvReferred;
use propel\propel\CareTzArvReferredQuery;
...
class CareTzArvReferredTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvReferredTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvReferred';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvReferred';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvReferred');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvReferred) { // it's a model object
