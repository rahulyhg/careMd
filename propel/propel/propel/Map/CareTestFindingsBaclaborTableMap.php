...
use propel\propel\CareTestFindingsBaclabor;
use propel\propel\CareTestFindingsBaclaborQuery;
...
class CareTestFindingsBaclaborTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsBaclaborTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsBaclabor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsBaclabor';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsBaclabor');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestFindingsBaclabor $obj A \propel\propel\CareTestFindingsBaclabor object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestFindingsBaclabor object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestFindingsBaclabor) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestFindingsBaclabor object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsBaclabor) { // it's a model object
