...
use propel\propel\CareTestFindingsRadio;
use propel\propel\CareTestFindingsRadioQuery;
...
class CareTestFindingsRadioTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTestFindingsRadioTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTestFindingsRadio';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTestFindingsRadio';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTestFindingsRadio');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareTestFindingsRadio $obj A \propel\propel\CareTestFindingsRadio object.
     ...
     *
     * @param mixed $value A \propel\propel\CareTestFindingsRadio object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareTestFindingsRadio) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareTestFindingsRadio object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTestFindingsRadio) { // it's a model object
