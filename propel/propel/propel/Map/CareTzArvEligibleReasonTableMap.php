...
use propel\propel\CareTzArvEligibleReason;
use propel\propel\CareTzArvEligibleReasonQuery;
...
class CareTzArvEligibleReasonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvEligibleReasonTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvEligibleReason';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvEligibleReason';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvEligibleReason');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvEligibleReason) { // it's a model object
