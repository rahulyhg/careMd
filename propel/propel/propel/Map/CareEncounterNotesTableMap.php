...
use propel\propel\CareEncounterNotes;
use propel\propel\CareEncounterNotesQuery;
...
class CareEncounterNotesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareEncounterNotesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareEncounterNotes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareEncounterNotes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareEncounterNotes');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareEncounterNotes) { // it's a model object
