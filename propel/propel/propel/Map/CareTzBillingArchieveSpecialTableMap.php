...
use propel\propel\CareTzBillingArchieveSpecial;
use propel\propel\CareTzBillingArchieveSpecialQuery;
...
class CareTzBillingArchieveSpecialTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingArchieveSpecialTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingArchieveSpecial';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingArchieveSpecial';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingArchieveSpecial');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingArchieveSpecial) { // it's a model object
