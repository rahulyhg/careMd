...
use propel\propel\CareCafePrices;
use propel\propel\CareCafePricesQuery;
...
class CareCafePricesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareCafePricesTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareCafePrices';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareCafePrices';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareCafePrices');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareCafePrices) { // it's a model object
