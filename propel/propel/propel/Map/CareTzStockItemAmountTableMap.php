...
use propel\propel\CareTzStockItemAmount;
use propel\propel\CareTzStockItemAmountQuery;
...
class CareTzStockItemAmountTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzStockItemAmountTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzStockItemAmount';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzStockItemAmount';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzStockItemAmount');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzStockItemAmount) { // it's a model object
