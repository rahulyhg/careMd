...
use propel\propel\CareTzEyeOpticDisc;
use propel\propel\CareTzEyeOpticDiscQuery;
...
class CareTzEyeOpticDiscTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzEyeOpticDiscTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzEyeOpticDisc';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzEyeOpticDisc';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzEyeOpticDisc');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzEyeOpticDisc) { // it's a model object
