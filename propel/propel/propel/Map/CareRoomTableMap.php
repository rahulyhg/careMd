...
use propel\propel\CareRoom;
use propel\propel\CareRoomQuery;
...
class CareRoomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareRoomTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareRoom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareRoom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareRoom');
     ...
     * and findPk*() calls.
     *
     * @param \propel\propel\CareRoom $obj A \propel\propel\CareRoom object.
     ...
     *
     * @param mixed $value A \propel\propel\CareRoom object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \propel\propel\CareRoom) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \propel\propel\CareRoom object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareRoom) { // it's a model object
