...
use propel\propel\CareIcd10De;
use propel\propel\CareIcd10DeQuery;
...
class CareIcd10DeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareIcd10DeTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareIcd10De';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareIcd10De';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareIcd10De');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareIcd10De) { // it's a model object
