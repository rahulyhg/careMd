...
use propel\propel\CareTzInsurance;
use propel\propel\CareTzInsuranceQuery;
...
class CareTzInsuranceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzInsuranceTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzInsurance';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzInsurance';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzInsurance');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzInsurance) { // it's a model object
