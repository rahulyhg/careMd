...
use propel\propel\CareClassFinancial;
use propel\propel\CareClassFinancialQuery;
...
class CareClassFinancialTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareClassFinancialTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareClassFinancial';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareClassFinancial';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareClassFinancial');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareClassFinancial) { // it's a model object
