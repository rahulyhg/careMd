...
use propel\propel\CareStandbyDutyReport;
use propel\propel\CareStandbyDutyReportQuery;
...
class CareStandbyDutyReportTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareStandbyDutyReportTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareStandbyDutyReport';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareStandbyDutyReport';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareStandbyDutyReport');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareStandbyDutyReport) { // it's a model object
