...
use propel\propel\CareTzArvRegistration;
use propel\propel\CareTzArvRegistrationQuery;
...
class CareTzArvRegistrationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzArvRegistrationTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzArvRegistration';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzArvRegistration';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzArvRegistration');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzArvRegistration) { // it's a model object
