...
use propel\propel\CareTzBillingSpecial;
use propel\propel\CareTzBillingSpecialQuery;
...
class CareTzBillingSpecialTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'propel.propel.Map.CareTzBillingSpecialTableMap';
     ...
     */
    const OM_CLASS = '\\propel\\propel\\CareTzBillingSpecial';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'propel.propel.CareTzBillingSpecial';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\propel\\propel\\CareTzBillingSpecial');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \propel\propel\CareTzBillingSpecial) { // it's a model object
