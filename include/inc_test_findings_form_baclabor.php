...
for ($n = 0; $n < 8; $n++) {
    ?>
                            ...
                            <!--  Barcode for the batch nr.  -->
                                    ...
                                    if ($in_cache)
                                        echo '<img src="../cache/barcodes/form_' . $batch_nr . '.png"  border=0>';
                                    ?>
		   ...
		   <a href="javascript:setM(\'findings_init\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="findings_init"></a><input type="hidden" name="findings_init" value="' . $inp_v . '">';
                                    else
                                        echo '>';
		   ...
		   <a href="javascript:setM(\'findings_current\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="findings_current"></a><input type="hidden" name="findings_current" value="' . $inp_v . '">';
                                    else
                                        echo '>';
		   ...
		   <a href="javascript:setM(\'findings_final\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="findings_final"></a><input type="hidden" name="findings_final" value="' . $inp_v . '">';
                                    else
                                        echo '>';
                      ...
                      <textarea name="notes" cols=25 rows=12 wrap="physical" >';
                                        if ($stored_findings['notes'])
                                            echo stripslashes($stored_findings['notes']);
                                        echo '</textarea>';
                                    }
                                    elseif ($stored_findings['notes'])
                                        echo '<font face="verdana,arial" color="#000000" size=2>' . nl2br(chunk_split(stripslashes($stored_findings['notes']), 35));
                                    ?>
		   ...
		   <a href="javascript:setM(\'' . $v2 . '\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="' . $v2 . '"></a><input type="hidden" name="' . $v2 . '" value="' . $inp_v . '">';
                                    else
                                        echo '>';
                                }
                    ...
                    <tr bgcolor="#fff3f3" valign="top">
                        <td><font size=1 color="#ee6666" face="verdana,arial"><?php
                                            ...
                                            if ($edit_findings) {
                                                ...
                                                if ($stored_findings['entry_nr'])
                                                    echo 'value="' . $stored_findings['entry_nr'] . '">';
                                                else
                                                    echo '>';
                                            }
                                            else {
                                                if ($stored_findings['entry_nr'])
                                                    echo $stored_findings['entry_nr'];
                                            }
                                            ?></td>
                        <td  colspan=2><font size=1 color="#ee6666" face="verdana,arial"><?php
                                            ...
                                            if ($edit_findings) {
                                                ...
                                                if ($stored_findings['rec_date'] && $stored_findings['rec_date'] != '0000-00-00')
...
?></font></td>
		   ...
		   <a href="javascript:setM(\'' . $x . '\')">';
                                ...
                                if ($edit_findings)
                                    echo ' border=0 id="' . $x . '"></a><input type="hidden" name="' . $x . '" value="' . $inp_v . '">';
                                else
                                    echo '>';
	   ...
	   ';
		   ...
		   <a href="javascript:setM(\'_tr_blocker_pos\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="_tr_blocker_pos"></a><input type="hidden" name="_tr_blocker_pos" value="' . $inp_v . '">';
                                    else
                                        echo '>';
		   ...
		   <a href="javascript:setM(\'_tr_blocker_neg\')">';
                                    ...
                                    if ($edit_findings)
                                        echo ' border=0 id="_tr_blocker_neg"></a><input type="hidden" name="_tr_blocker_neg" value="' . $inp_v . '">';
                                    else
                                        echo '>';
		   ...
		   <a href="javascript:setM(\'_tr_mark_streptococcus\')">';
                                        ...
                                        if ($edit_findings)
                                            echo ' border=0 id="_tr_mark_streptococcus"></a><input type="hidden" name="_tr_mark_streptococcus" value="' . $inp_v . '">';
                                        else
                                            echo '>';
		   ...
		   <a href="javascript:setM(\'_tr_pathogenmore\')">';
                                        ...
                                        if ($edit_findings)
                                            echo ' border=0 id="_tr_pathogenmore"></a><input type="hidden" name="_tr_pathogenmore" value="' . $inp_v . '">';
                                        else
                                            echo '>';
		   ...
		   <a href="javascript:setM(\'_tr_pathogenless\')">';
                                        ...
                                        if ($edit_findings)
                                            echo ' border=0 id="_tr_pathogenless"></a><input type="hidden" name="_tr_pathogenless" value="' . $inp_v . '">';
                                        else
                                            echo '>';
		   ...
		   <a href="javascript:setM(\'_tr_patho_neg\')">';
                                        ...
                                        if ($edit_findings)
                                            echo ' border=0 id="_tr_patho_neg"></a><input type="hidden" name="_tr_patho_neg" value="' . $inp_v . '">';
                                        else
                                            echo '>';
	         ...
	         <tr>';
               ...
               <td><br>';
                                            ...
                                            for ($n = 0; $n < 3; $n++) {
                                                ...
                                                if ($edit_findings)
                                                    echo '<a href="javascript:setM(\'' . $v2 . '\')">';
	   ...
	   <td><br>';
                        ...
                        <td align="right">
                            <table border=0 cellpadding=0 cellspacing=0>
                                ...
                                <?php
                                if ($edit_findings)
                                    echo '<a href="javascript:setM(\'_rx_pathogen_1_\')">';
                                ...
                                if ($edit_findings)
                                    echo ' border=0 id="_rx_pathogen_1_"></a><input type="hidden" name="_rx_pathogen_1_" value="' . $inp_v . '">';
                                else
                                    echo '>';
                                echo $LDBAC[0];
                                ?> 
...
?>	
                                    ...
                                    <td>
                                        ...
                                        <table border=0 class="lab" cellpadding=0 cellspacing=0> 	
                                            ...
                                            <?php
                                            if ($edit_findings)
                                                echo '<a href="javascript:setM(\'_rx_pathogen_2_\')">';
                                            ...
                                            if ($edit_findings)
                                                echo ' border=0 id="_rx_pathogen_2_"></a><input type="hidden" name="_rx_pathogen_2_" value="' . $inp_v . '">';
                                            else
                                                echo '>';
                                            echo $LDBAC[1];
                                            ?> 
               ...
               <td>&nbsp;S&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M&nbsp;&nbsp;&nbsp;&nbsp;R<br>';
                                    ...
                                    <td>
                                        ...
                                        <table border=0 class="lab" cellpadding=0 cellspacing=0> 	
                                            ...
                                            <?php
                                            if ($edit_findings)
                                                echo '<a href="javascript:setM(\'_rx_pathogen_3_\')">';
                                            ...
                                            if ($edit_findings)
                                                echo ' border=0 id="_rx_pathogen_3_"></a><input type="hidden" name="_rx_pathogen_3_" value="' . $inp_v . '">';
                                            else
                                                echo '>';
                                            echo $LDBAC[2];
                                            ?> 
               ...
               <td>&nbsp;S&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M&nbsp;&nbsp;&nbsp;&nbsp;R<br>';
                                    ...
                                    <td>
                                        ...
                                        <table border=0 class="lab" cellpadding=0 cellspacing=0> 	
                                            ...
                                            <?php
                                            if ($edit_findings)
                                                echo '<a href="javascript:setM(\'_rx_fungus_\')">';
                                            ...
                                            if ($edit_findings)
                                                echo ' border=0 id="_rx_fungus_"></a><input type="hidden" name="_rx_fungus_" value="' . $inp_v . '">';
                                            else
                                                echo '>';
                                            echo $LDFungi;
                                            ?> 
	         ...
	         <tr>';
               ...
               <td>';
                                                if ($tr_tracker == 6) {
                                                    ...
                                                    if ($edit_findings)
                                                        echo '<a href="javascript:setM(\'_rx_eye_' . $rx_tracker . '\')">';
                                                    ...
                                                    if ($edit_findings)
                                                        echo ' border=0 id="_rx_eye_' . $rx_tracker . '"></a><input type="hidden" name="_rx_eye_' . $rx_tracker . '" value="' . $inp_v . '">';
                                                    else
                                                        echo '>';
                                                ...
                                                elseif ($tr_tracker == 7) {
                                                    ...
                                                    if ($edit_findings)
                                                        echo '<a href="javascript:setM(\'_rx_bac_' . $rx_tracker . '\')">';
                                                    ...
                                                    if ($edit_findings)
                                                        echo ' border=0 id="_rx_bac_' . $rx_tracker . '"></a><input type="hidden" name="_rx_bac_' . $rx_tracker . '" value="' . $inp_v . '">';
                                                    else
                                                        echo '>';
